...
function LoginPageContent() {
  ...
  return (
    <div
      ...
      data-next={nextUrl}
      className="min-h-screen flex items-center justify-center bg-lia-bg-secondary p-4"
    >
      <div className="w-full max-w-md bg-lia-bg-primary rounded-lg shadow p-8 space-y-6">
        <h1 className="text-2xl font-semibold text-center text-lia-text-primary">
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
          <div>
            <label htmlFor="email" className="block text-sm font-medium text-lia-text-primary mb-1">
              E-mail
            </label>
            <input
              id="email"
              type="email"
              autoComplete="email"
              className="w-full border border-lia-border-default rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              {...register("email")}
            />
            {errors.email && (
          ...
          <div>
            <label htmlFor="password" className="block text-sm font-medium text-lia-text-primary mb-1">
              Senha
            </label>
            <input
              id="password"
