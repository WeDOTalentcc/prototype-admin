...
export async function POST(request: NextRequest) {
  try {
    ...
    // middleware can validate the JWT (without this we get 401 and WSI
    // question regeneration breaks silently).
    ...
    const response = await fetch(`${BACKEND_URL}/api/v1/wsi/regenerate-questions`, {
      method: 'POST',
      headers,
