...
const subprocessors = [
  ...
  { id: 10, name: 'StackOne', service: 'Unified ATS API', country: 'EUA', region: 'Global', purpose: 'Integração unificada com 40+ sistemas ATS/HRIS', category: 'integration', certifications: 'SOC 2 Type II' },
