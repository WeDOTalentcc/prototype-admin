      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {resources.map((resource) => {
            ...
            return (
              <div 
                key={resource.id}
                className="rounded-md border p-4 hover:transition-shadow bg-lia-bg-primary dark:bg-lia-bg-primary border-lia-border-subtle dark:border-lia-border-subtle"
                
              >
                <div className="flex items-start gap-4">
                  <div 
                    className="w-10 h-10 rounded-md flex items-center justify-center shrink-0"
                    style={{backgroundColor: resource.requestRequired ? 'var(--status-warning-bg)' : 'var(--lia-interactive-active)'}}
                  >
                    <IconComponent 
                      className="w-5 h-5" 
                      style={{color: resource.requestRequired ? 'var(--status-warning)' : 'var(--lia-text-secondary)'}}
                    />
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-medium text-sm text-lia-text-primary dark:text-lia-text-primary" >
                        {resource.name}
                      </h3>
                      <span 
                        className="px-1.5 py-0.5 rounded-md text-xs font-medium bg-lia-bg-secondary dark:bg-lia-bg-primary text-lia-text-tertiary dark:text-lia-text-secondary"
                    ...
                    {resource.downloadable ? (
                      ...
                      <button 
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium border hover:bg-lia-bg-secondary transition-colors motion-reduce:transition-none text-status-warning" style={{
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-medium text-sm mb-1 text-lia-text-primary dark:text-lia-text-primary" >
              ...
              <p className="text-sm text-lia-text-secondary dark:text-lia-text-tertiary" >
                ...
                Para solicitar acesso, entre em contato com <span className="text-lia-text-primary">compliance@lia.ai</span>
              </p>
            </div>
          </div>
        </div>
