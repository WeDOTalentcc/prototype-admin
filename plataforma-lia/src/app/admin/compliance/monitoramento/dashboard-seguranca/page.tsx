...
const getSeverityConfig = (severity: string) => {
  switch (severity) {
    ...
    default:
      return { label: severity, color: 'bg-lia-bg-tertiary text-lia-text-primary dark:text-lia-text-primary', dot: 'bg-lia-bg-secondary0' }
  }
}
...
const getStatusConfig = (status: string) => {
  switch (status) {
    ...
    case 'acknowledged':
      return { label: 'Reconhecido', color: 'bg-lia-bg-tertiary dark:bg-lia-bg-secondary text-lia-text-primary dark:text-lia-text-primary', icon: CheckCircle2 }
    case 'resolved':
    ...
    <div className="p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-3 mb-6">
          ...
          >
            <MonitorDot className="w-5 h-5 text-lia-text-secondary dark:text-lia-text-tertiary" />
          </div>
          <div>
            <h1 
          ...
          <Card >
            <CardContent className="p-6">
              <div className="flex items-start justify-between">
                ...
                <div className="w-10 h-10 rounded-md flex items-center justify-center bg-lia-interactive-active/30">
                  <Gauge className="w-5 h-5 text-lia-text-secondary dark:text-lia-text-tertiary" />
                </div>
              </div>
              <div className="mt-3">
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                <div 
                  className="w-10 h-10 rounded-md flex items-center justify-center bg-lia-interactive-active/30"
                >
                  <KeyRound className="w-5 h-5 text-lia-text-secondary dark:text-lia-text-tertiary" />
                </div>
                <div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="flex items-center gap-3 p-3 rounded-md border border-lia-border-subtle dark:border-lia-border-subtle" >
                ...
                <div>
                  <p className="text-sm font-medium text-lia-text-primary dark:text-lia-text-primary" >SSO</p>
                  <p className="text-xs text-lia-text-tertiary dark:text-lia-text-secondary" >Ativo</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-md border border-lia-border-subtle dark:border-lia-border-subtle" >
                <div className="w-2 h-2 rounded-full bg-status-success" />
                <div>
                  <p className="text-sm font-medium text-lia-text-primary dark:text-lia-text-primary" >SCIM</p>
                  <p className="text-xs text-lia-text-tertiary dark:text-lia-text-secondary" >Ativo</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-md border border-lia-border-subtle dark:border-lia-border-subtle" >
                <div className="w-2 h-2 rounded-full bg-status-success" />
                <div>
                  <p className="text-sm font-medium text-lia-text-primary dark:text-lia-text-primary" >MFA</p>
                  <p className="text-xs text-lia-text-tertiary dark:text-lia-text-secondary" >Habilitado</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-md border border-lia-border-subtle dark:border-lia-border-subtle" >
                <Users className="w-4 h-4 text-lia-text-secondary dark:text-lia-text-tertiary" />
                <div>
                  <p className="text-sm font-medium text-lia-text-primary dark:text-lia-text-primary" >Sessões</p>
                  <p className="text-xs text-lia-text-tertiary dark:text-lia-text-secondary" >Gerenciadas via WorkOS</p>
                </div>
              </div>
            </div>
          </CardContent>
            ...
            <CardContent>
              <div className="flex items-end justify-between h-40 gap-3">
                {eventsByDay.map((item, idx) => (
                  <div key={idx} className="flex flex-col items-center flex-1">
                    ...
                    <span className="text-xs font-medium mt-2 text-lia-text-primary dark:text-lia-text-primary" >
                      {item.count}
                    </span>
              ...
              <div className="flex items-center justify-center gap-6 mt-4 pt-3 border-t border-lia-border-subtle dark:border-lia-border-subtle" >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-lia-text-tertiary dark:text-lia-text-secondary" >Crítico</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-md bg-status-warning" />
                  <span className="text-xs text-lia-text-tertiary dark:text-lia-text-secondary" >Alto</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-md bg-status-warning" />
                  <span className="text-xs text-lia-text-tertiary dark:text-lia-text-secondary" >Médio</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-md bg-status-success" />
                  <span className="text-xs text-lia-text-tertiary dark:text-lia-text-secondary" >Baixo</span>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {topEventTypes.map((event, idx) => (
                  <div 
                    key={idx}
                    className="flex items-center justify-between p-3 rounded-md border hover:bg-lia-bg-secondary transition-colors motion-reduce:transition-none border-lia-border-subtle dark:border-lia-border-subtle"
                    
                  >
                    <div className="flex items-center gap-3">
                      <div 
                        className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium bg-lia-interactive-active/30"
                      >
                        {idx + 1}
                      </div>
                      <span className="text-sm font-medium text-lia-text-primary dark:text-lia-text-primary" >
          ...
          <Card className="lg:col-span-2" >
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                ...
                <Badge className="bg-lia-bg-tertiary dark:bg-lia-bg-secondary text-lia-text-secondary dark:text-lia-text-tertiary">
                  ...
                  {recentEvents.map((event) => {
                    ...
                    return (
                      <TableRow key={event.id} className="hover:bg-lia-bg-secondary">
                        <TableCell>
                          <span className="text-xs font-mono text-lia-text-secondary dark:text-lia-text-tertiary" >
                        ...
                        <TableCell className="hidden md:table-cell max-w-sidebar-content">
                          <span className="text-xs truncate block text-lia-text-tertiary dark:text-lia-text-secondary" >
                            {event.description}
                          </span>
                        </TableCell>
