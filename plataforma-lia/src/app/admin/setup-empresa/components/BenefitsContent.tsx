      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="gap-2 bg-lia-btn-primary-hover"
          >
      ...
      {isLoading ? (
        ...
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center justify-center py-12">
            <Gift className="w-12 h-12 text-lia-text-disabled mb-4" />
            <h3 className="text-lg font-medium mb-2 text-lia-text-primary dark:text-lia-text-primary">
              Nenhum benefício cadastrado
            </h3>
            <p className="text-sm text-center mb-4 text-lia-text-secondary dark:text-lia-text-tertiary">
          ...
          {BENEFIT_CATEGORIES.map((category) => {
            ...
            return (
              <Card key={category.id}>
                <div
                  className="flex items-center justify-between px-4 py-3 cursor-pointer hover:bg-lia-bg-secondary dark:hover:bg-lia-btn-primary-hover/50"
                ...
                {isExpanded && (
                  <div className="border-t border-lia-border-subtle dark:border-lia-border-subtle">
                    {categoryBenefits.map((benefit) => (
                      <div
                        key={benefit.id}
                        className="flex items-center justify-between px-4 py-3 hover:bg-lia-bg-secondary dark:hover:bg-lia-btn-primary-hover/50 border-b last:border-b-0 border-lia-border-subtle dark:border-lia-border-subtle"
                      >
                        <div className="flex items-center gap-3 flex-1">
                          <GripVertical className="w-4 h-4 text-lia-text-disabled cursor-grab" />
