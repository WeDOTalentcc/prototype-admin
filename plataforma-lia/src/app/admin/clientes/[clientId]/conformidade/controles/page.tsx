...
const statusColors: Record<string, string> = {
  ...
  verified: 'bg-lia-bg-tertiary text-lia-text-primary dark:bg-lia-bg-secondary dark:text-lia-text-primary',
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-center py-12">
          ...
          <span className="ml-3 text-sm text-lia-text-tertiary dark:text-lia-text-secondary">Carregando controles...</span>
        </div>
      </div>
    )
  }
    ...
    <div className="space-y-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-lia-border-subtle dark:border-lia-border-subtle">
                    <th className="text-left py-3 px-2 text-xs font-medium text-lia-text-tertiary dark:text-lia-text-secondary">Código</th>
                    <th className="text-left py-3 px-2 text-xs font-medium text-lia-text-tertiary dark:text-lia-text-secondary">Descrição</th>
                    <th className="text-left py-3 px-2 text-xs font-medium text-lia-text-tertiary dark:text-lia-text-secondary">Seção</th>
                    <th className="text-left py-3 px-2 text-xs font-medium text-lia-text-tertiary dark:text-lia-text-secondary">Resultado</th>
                    <th className="text-left py-3 px-2 text-xs font-medium text-lia-text-tertiary dark:text-lia-text-secondary">Último Teste</th>
                  </tr>
                </thead>
                <tbody>
                  {soxControls.slice(0, 10).map((sox) => (
                    <tr key={sox.id} className="border-b hover:bg-lia-bg-secondary dark:hover:bg-lia-btn-primary-hover/50 border-lia-border-subtle dark:border-lia-border-subtle">
                      <td className="py-3 px-2 text-sm font-mono text-lia-text-primary dark:text-lia-text-primary">{sox.controlId}</td>
                      <td className="py-3 px-2 text-sm text-lia-text-primary dark:text-lia-text-primary">{sox.description}</td>
                      <td className="py-3 px-2">
                      ...
                      <td className="py-3 px-2 text-sm text-lia-text-tertiary dark:text-lia-text-secondary">{formatDate((sox as any).lastTestedAt)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      {dashboard && dashboard.upcomingReviews > 0 && (
        <Card>
          ...
          <CardContent>
            <div className="p-4 rounded-md bg-lia-bg-secondary dark:bg-lia-bg-secondary/50 border border-lia-border-default dark:border-lia-border-default">
