          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2" aria-label="Próximos passos">
              {summary.nextSteps.map((step, i) => (
                ...
                >
                  <span className="flex-shrink-0 w-5 h-5 rounded-full bg-gray-100 dark:bg-lia-bg-elevated flex items-center justify-center text-micro font-['Inter',sans-serif] font-medium text-lia-text-tertiary dark:text-lia-text-tertiary mt-0.5">
                    {i + 1}
                  </span>
                  {step}
                </li>
