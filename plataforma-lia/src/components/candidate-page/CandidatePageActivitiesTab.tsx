...
export function CandidatePageActivitiesTab({
      ...
      <Card>
        <CardContent className="p-4">
          <div className="flex items-center justify-between mb-3">
            <h4 className="text-sm font-medium text-gray-950 flex items-center gap-1.5">
 ...
 viewMode === 'timeline'
                      ? 'bg-gray-200 text-gray-900 dark:text-lia-text-primary'
                      : 'text-gray-700 dark:text-lia-text-secondary hover:text-gray-900 dark:hover:text-gray-100'
                  }`}
 ...
 activityFilter === 'all'
                  ...
                  : 'bg-gray-100 dark:bg-lia-bg-elevated text-gray-600 dark:text-lia-text-tertiary hover:bg-gray-200'
              }`}
            >
              Todas
            </button>
 ...
 activityFilter === 'emails'
                  ...
                  : 'bg-gray-100 dark:bg-lia-bg-elevated text-gray-700 dark:text-lia-text-secondary hover:bg-gray-200 dark:hover:bg-gray-600'
              }`}
            >
              📧 Emails
            </button>
                ...
                <div key={prediction.id} className="bg-white dark:bg-lia-bg-secondary rounded-md p-3">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      <h5 className="text-xs font-semibold text-gray-950">
                        {prediction.title}
                      </h5>
                      <Badge
                      ...
                      <p className="text-xs text-gray-600 dark:text-lia-text-tertiary italic mt-1">
                            ...
                            <div className="flex-1">
                              <div className="flex items-start justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <ChevronDown
                                    className={`w-4 h-4 text-gray-600 dark:text-lia-text-tertiary transition-transform ${
                              ...
                              <div className="mt-2 space-y-2">
                                <div className="grid grid-cols-2 gap-2">
                                  <div className="bg-gray-50 dark:bg-lia-bg-secondary p-2 rounded-md">
                                    <span className="text-xs text-gray-800 dark:text-lia-text-primary">Score Técnico</span>
                                    <p className="text-sm font-semibold">{activity.details.technicalScore}%</p>
                                  </div>
                                  <div className="bg-gray-50 dark:bg-lia-bg-secondary p-2 rounded-md">
                                    <span className="text-xs text-gray-800 dark:text-lia-text-primary">Fit Cultural</span>
                            ...
                            {activity.type === 'whatsapp-screening' && activity.details.conversation && (
                              <div className="mt-2 space-y-2">
                                <div className="bg-gray-50 dark:bg-lia-bg-secondary p-2 rounded-md max-h-48 overflow-y-auto">
                                  <p className="text-xs text-gray-800 dark:text-lia-text-primary mb-2">Conversa via {activity.platform}</p>
 ...
 msg.sender === 'LIA'
                                              ...
                                              : 'bg-gray-100 dark:bg-lia-bg-elevated text-gray-700 dark:text-lia-text-secondary'
                                          }`}
                                        >
                                          <p>{msg.message}</p>
