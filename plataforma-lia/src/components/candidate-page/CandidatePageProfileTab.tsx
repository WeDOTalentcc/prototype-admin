            ...
            <CardContent className="p-4 space-y-2">
              ...
              {candidate.gender && (
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-medium text-gray-800 dark:text-gray-200">{candidate.gender}</span>
                </div>
              )}
              {candidate.nationality && (
                <div className="flex justify-between items-center">
                  <span className="text-xs text-gray-500 dark:text-gray-500">Nacionalidade</span>
                  <span className="text-sm font-medium text-gray-800 dark:text-gray-200">{candidate.nationality}</span>
                </div>
              )}
              {candidate.marital_status && (
                <div className="flex justify-between items-center">
                  <span className="text-xs text-gray-500 dark:text-gray-500">Estado Civil</span>
                  <span className="text-sm font-medium text-gray-800 dark:text-gray-200">{candidate.marital_status}</span>
                </div>
              )}
            </CardContent>
          </Card>
