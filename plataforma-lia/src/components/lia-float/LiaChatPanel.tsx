...
import { Brain, X, Maximize2, Loader2, Send, ArrowRight } from "lucide-react"
...
export function LiaChatPanel() {
  ...
  return (
    ...
    >
      ...
      {wsError && (
        <div className="px-4 py-1.5 bg-red-50 dark:bg-red-950/30 border-b border-red-100 dark:border-red-900 flex-shrink-0">
          <p className="text-[11px] text-red-600 dark:text-red-400" style={{ fontFamily: "Open Sans, sans-serif" }}>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        {isFetchingHistory ? (
          ...
          <>
            ...
            {/* Card HITL — aguardando aprovação do recrutador */}
            {hitlPending && (
