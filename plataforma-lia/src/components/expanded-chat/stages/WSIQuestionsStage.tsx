  ...
  const renderQuestionCard = (q: WSIQuestionCandidate) => (
    ...
    >
      <button
        ...
        className="absolute top-2 right-2 text-gray-400 hover:text-red-500 transition-colors focus-visible:ring-2 focus-visible:ring-gray-400 rounded"
  ...
  return (
    <div className="space-y-2.5">
      <div className="flex items-center justify-between mb-1">
        ...
        <div className="flex items-center gap-1">
          <span className={cn(
            ...
            selectedCount === 5 ? "text-green-500" : "text-gray-600 dark:text-gray-400"
          )}>
            {selectedCount}
          </span>
      ...
      {!isGeneratingWSI && selectedCount < 5 && (
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex-1 py-2 border border-dashed border-purple-600 rounded-md text-xs text-purple-600 hover:bg-purple-600/5 transition-all flex items-center justify-center gap-2 focus-visible:ring-2 focus-visible:ring-gray-400"
      ...
      <div className={cn(
        ...
        selectedCount === 5
          ? "bg-green-100 border-green-500/30"
