...
export function CalibrationProfileModal({
      ...
      <div className="bg-lia-bg-primary rounded-xl w-[95vw] max-w-[1200px] h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-lia-border-subtle">
          <div className="flex items-center gap-3">
            <button
              onClick={onClose}
              className="flex items-center gap-2 lia-text-secondary hover:lia-text-strong transition-colors"
            >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {candidate.linkedinUrl && (
                      <a
                        ...
                        className="lia-text-secondary hover:lia-text-strong dark:hover:lia-text-muted transition-colors"
                      >
 ...
 "p-1.5 rounded-md transition-colors",
              ...
              <div className="flex gap-2">
                <button
                  onClick={onApprove}
                  className="flex-1 py-2.5 px-3 bg-gray-900 text-white rounded-md font-medium text-xs hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors flex items-center justify-center gap-1.5"
                >
                ...
                <button
                  onClick={onReject}
                  className="flex-1 py-2.5 px-3 bg-lia-bg-primary text-status-error border border-status-error rounded-md font-medium text-xs hover:bg-status-error/5 transition-colors flex items-center justify-center gap-1.5"
                >
