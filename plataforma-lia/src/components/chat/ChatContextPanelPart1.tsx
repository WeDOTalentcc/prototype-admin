              ...
              <div className="space-y-6">
                <div className="p-5 rounded-md bg-stone-50 dark:bg-stone-900/20">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <p className="text-xl font-bold lia-text-800 dark:text-lia-text-primary">{contextData.data.recommended_package.base_salary.target}</p>
                    </div>
                  ...
                  <p className="text-sm lia-text-500 dark:text-lia-text-tertiary">{contextData.data.recommended_package.total_compensation.positioning}</p>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 rounded-md border bg-gray-100 dark:bg-lia-bg-secondary border-lia-border-subtle dark:border-lia-border-subtle">
                    ...
                    <p className="text-lg font-semibold lia-text-800 dark:text-lia-text-primary">{contextData.data.market_analysis.salary_research.market_median}</p>
                  </div>
                  <div className="p-4 rounded-md border bg-gray-100 dark:bg-lia-bg-secondary border-lia-border-subtle dark:border-lia-border-subtle">
                    <h4 className="text-sm font-medium lia-text-600 dark:text-lia-text-tertiary mb-3">Faixa Recomendada</h4>
                    <p className="text-base font-semibold lia-text-800 dark:text-lia-text-primary">{contextData.data.recommended_package.base_salary.min} - {contextData.data.recommended_package.base_salary.max}</p>
                  </div>
                </div>
                <div>
                ...
                <div className="p-4 rounded-md border bg-gray-100 dark:bg-lia-bg-secondary border-lia-border-subtle dark:border-lia-border-subtle">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xl font-bold lia-text-800 dark:text-lia-text-primary">{contextData.data.recommended_package.total_compensation.total_annual}</span>
                  </div>
                </div>
            ...
            <CardContent className="p-6">
              <div className="space-y-6">
                <div className="p-5 rounded-md bg-wedo-cyan/15 dark:bg-wedo-cyan/20">
                  <h5 className="text-lg font-bold mb-2 lia-text-800 dark:text-lia-text-primary">{contextData.data.current_structure.missing_layer.role}</h5>
                  <p className="text-sm mb-3 lia-text-500 dark:text-lia-text-tertiary">{contextData.data.current_structure.missing_layer.purpose}</p>
                  <div className="p-3 rounded-md bg-gray-100 dark:bg-lia-bg-secondary">
                    <p className="text-sm font-medium lia-text-800 dark:text-lia-text-primary">{contextData.data.current_structure.missing_layer.impact}</p>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 rounded-md border bg-gray-100 dark:bg-lia-bg-secondary border-lia-border-subtle dark:border-lia-border-subtle">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between"><span className="text-sm lia-text-500 dark:text-lia-text-tertiary">Porte:</span><span className="font-semibold lia-text-800 dark:text-lia-text-primary">{contextData.data.company_overview.size}</span></div>
                      <div className="flex justify-between"><span className="text-sm lia-text-500 dark:text-lia-text-tertiary">Setor:</span><span className="font-semibold lia-text-800 dark:text-lia-text-primary">{contextData.data.company_overview.industry}</span></div>
                      <div className="flex justify-between"><span className="text-sm lia-text-500 dark:text-lia-text-tertiary">Time Tech Atual:</span><span className="font-semibold lia-text-800 dark:text-lia-text-primary">{contextData.data.company_overview.current_tech_team} pessoas</span></div>
                    </div>
                  </div>
                  <div className="p-4 rounded-md border bg-gray-100 dark:bg-lia-bg-secondary border-lia-border-subtle dark:border-lia-border-subtle">
                    <h4 className="text-sm font-medium lia-text-600 dark:text-lia-text-tertiary mb-3">Projeção de Crescimento</h4>
                    <div className="space-y-2">
                      <div className="flex justify-between"><span className="text-sm lia-text-500 dark:text-lia-text-tertiary">6 meses:</span><span className="font-semibold lia-text-800 dark:text-lia-text-primary">{contextData.data.growth_projection.projected_6months} pessoas</span></div>
                      <div className="flex justify-between"><span className="text-sm lia-text-500 dark:text-lia-text-tertiary">12 meses:</span><span className="font-semibold lia-text-800 dark:text-lia-text-primary">{contextData.data.growth_projection.projected_12months} pessoas</span></div>
                    </div>
                  </div>
                </div>
                <div className="flex gap-3 pt-2">
            ...
            <CardContent className="p-6">
              <div className="space-y-6">
                <div className="p-5 rounded-md bg-status-warning/10 dark:bg-status-warning/20">
                  ...
                  <p className="text-base font-bold lia-text-800 dark:text-lia-text-primary">{contextData.data.role_focus}</p>
                </div>
                <div>
            ...
            <CardContent className="p-6">
              <div className="space-y-4 font-open-sans">
                <div className="grid grid-cols-2 gap-6">
                  <div><h4 className="text-sm font-medium lia-text-600 dark:text-lia-text-tertiary mb-2">Modalidade</h4><p className="font-semibold">{contextData.data.arrangement}</p></div>
                  <div><h4 className="text-sm font-medium lia-text-600 dark:text-lia-text-tertiary mb-2">Flexibilidade</h4><p className="font-semibold">{contextData.data.flexibility}</p></div>
                </div>
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <h4 className="text-sm font-medium lia-text-600 dark:text-lia-text-tertiary mb-2">Dias Presenciais</h4>
                    <div className="flex flex-wrap gap-1">{contextData.data.office_days.map((day: string, index: number) => (<Badge key={`${index}-${day}`} variant="outline" className="text-xs">{day}</Badge>))}</div>
                  </div>
                  <div>
                    <h4 className="text-sm font-medium lia-text-600 dark:text-lia-text-tertiary mb-2">Home Office</h4>
                    <div className="flex flex-wrap gap-1">{contextData.data.home_office_days.map((day: string, index: number) => (<Badge key={`${index}-${day}`} variant="outline" className="text-xs">{day}</Badge>))}</div>
                  </div>
                </div>
                <div><h4 className="text-sm font-medium lia-text-600 dark:text-lia-text-tertiary mb-2">Benefícios Inclusos</h4><p className="text-sm lia-text-600 dark:text-lia-text-tertiary">{contextData.data.benefits}</p></div>
              </div>
            </CardContent>
          </Card>
        </div>
              ...
              <div className="space-y-6 font-open-sans">
                ...
                <div className="border-t-0 pt-4">
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div><p className="text-sm font-semibold lia-text-800 dark:text-lia-text-primary">{contextData.data.compensation_highlights.total_package.split(' ')[1]}</p><p className="text-xs lia-text-600">Total Anual</p></div>
                    <div><p className="text-sm font-medium">{contextData.data.compensation_highlights.variable_bonus}</p><p className="text-xs lia-text-600">Bônus Variável</p></div>
                    <div><p className="text-sm font-medium">{contextData.data.compensation_highlights.benefits_value}</p><p className="text-xs lia-text-600">Benefícios</p></div>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="border-0 bg-white dark:lia-bg-950">
            <CardHeader className="bg-gray-100 dark:bg-lia-bg-secondary">
              <CardTitle className="flex items-center justify-between">
                ...
                <Badge className="bg-status-success/10 dark:bg-status-success/20 lia-text-800 dark:text-lia-text-primary">{contextData.data.ats_integration.status}</Badge>
              </CardTitle>
            </CardHeader>
            <CardContent className="p-6">
              <div className="space-y-6">
                <div className="p-5 rounded-md bg-wedo-cyan/15 dark:bg-wedo-cyan/20">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <h4 className="text-base font-bold mt-1 lia-text-800 dark:text-lia-text-primary">{contextData.data.ats_integration.system}</h4>
                    </div>
                    <div className="text-right">
                      <p className="text-xs lia-text-500 dark:text-lia-text-tertiary">Job ID</p>
                      <p className="text-sm font-mono font-semibold lia-text-800 dark:text-lia-text-primary">{contextData.data.ats_integration.job_id}</p>
                    </div>
                  </div>
                </div>
                <div>
