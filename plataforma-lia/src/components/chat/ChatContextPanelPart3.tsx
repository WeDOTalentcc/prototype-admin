              ...
              <div className="space-y-6 font-open-sans">
                <div className="p-4 rounded-xl bg-status-error/10 dark:bg-status-error/20">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div><span className="text-lia-text-secondary">Processos Históricos:</span><p className="font-semibold">{data.analysis_base.historical_processes}</p></div>
                    <div><span className="text-lia-text-secondary">Pontos de Dados:</span><p className="font-semibold">{data.analysis_base.data_points.toLocaleString()}</p></div>
                  </div>
                </div>
                <div>
