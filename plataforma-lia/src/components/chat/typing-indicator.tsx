...
export function TypingIndicator({ className }: TypingIndicatorProps) {
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 rounded-md bg-lia-bg-tertiary border border-lia-border-subtle px-4 py-3">
        ...
        <span className="text-xs font-['Open_Sans',sans-serif] text-lia-text-secondary animate-pulse motion-reduce:animate-none">
          LIA está pensando...
        </span>
      </div>
