...
export function NewIntegrationModal({ newIntegration, onChange, onCreate, onCancel }: NewIntegrationModalProps) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-lia-bg-primary dark:bg-lia-bg-secondary rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {AVAILABLE_EVENTS.map((event) => (
                  <label key={event.id} className="flex items-center gap-2 p-2 border border-lia-border-subtle dark:border-lia-border-subtle rounded-xl cursor-pointer hover:bg-lia-bg-secondary dark:hover:bg-lia-bg-inverse">
                    <input
                      type="checkbox"
