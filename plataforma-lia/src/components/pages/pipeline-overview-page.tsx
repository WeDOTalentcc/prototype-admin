      ...
      <div className="px-6 py-5 border-b border-lia-border-subtle flex-shrink-0">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-lia-bg-tertiary flex items-center justify-center">
              <GitBranch className="w-5 h-5 text-lia-text-primary" />
            </div>
            <div>
              ...
              <p className="text-sm text-lia-text-secondary">
                Panorama consolidado de todas as vagas ativas ·{" "}
                {totalCandidates} candidato
                {totalCandidates !== 1 ? "s" : ""} em processo
              </p>
            </div>
          </div>
          <Button
