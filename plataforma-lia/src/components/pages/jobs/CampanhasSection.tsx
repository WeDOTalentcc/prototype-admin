...
function CampanhasEmptyState() {
  return (
    <div className="col-span-full flex flex-col items-center justify-center py-16 text-center gap-3">
      ...
      <p className="text-body text-lia-text-primary font-medium">Nenhuma campanha ativa</p>
      <p className="text-small text-lia-text-secondary max-w-xs">
        Crie uma campanha para organizar e automatizar seu processo de sourcing e triagem.
      </p>
    </div>
  )
}
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            onClick={() => {
              window.location.href = `/pt/campaigns/${campaign.id}`
            }}
          >
            Ver detalhes
...
export function CampanhasSection() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-heading-sm text-lia-text-primary font-semibold">Campanhas de Recrutamento</h2>
        <button
          type="button"
          className="text-small text-lia-btn-primary-bg hover:underline"
          onClick={() => {
            window.location.href = "/pt/campaigns/new"
          }}
        >
          + Nova campanha
        </button>
