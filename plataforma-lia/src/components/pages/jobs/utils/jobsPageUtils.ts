...
export function filterJobs(
  ...
  return allJobs.filter(job => {
    ...
    if (jobFilters.position?.levels?.length) matchesInlineFilters = matchesInlineFilters && jobFilters.position.levels.some(l => job.level.toLowerCase().includes(l.toLowerCase()))
