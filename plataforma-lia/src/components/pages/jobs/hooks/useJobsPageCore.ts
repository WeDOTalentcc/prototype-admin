...
export function useJobsPageCore(props: JobsPageProps) {
  ...
  return {
    ...
    showEditJobModal: previewState.showEditJobModal,
    setShowEditJobModal: previewActions.setShowEditJobModal,
    editingJob: previewState.editingJob,
    setEditingJob: previewActions.setEditingJob,
