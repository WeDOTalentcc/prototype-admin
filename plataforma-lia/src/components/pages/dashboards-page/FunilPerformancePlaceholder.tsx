...
export function FunilPerformancePlaceholder() {
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-open-sans font-semibold text-lia-text-primary dark:text-lia-text-primary">Candidaturas Recebidas</p>
                  <p className={`${textStyles.description} dark:text-lia-text-tertiary`}>100% do funil</p>
                </div>
                <span className="text-lg font-inter font-bold text-lia-text-primary dark:text-lia-text-primary">3.247</span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-open-sans font-semibold text-lia-text-primary dark:text-lia-text-primary">Triagem LIA Aprovada</p>
                  <p className={`${textStyles.description} dark:text-lia-text-tertiary`}>62% conversão</p>
                </div>
                <span className="text-lg font-inter font-bold text-lia-text-primary dark:text-lia-text-primary">2.013</span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-open-sans font-semibold text-lia-text-primary dark:text-lia-text-primary">Entrevistas Agendadas</p>
                  <p className={`${textStyles.description} dark:text-lia-text-tertiary`}>38% conversão (total)</p>
                </div>
                <span className="text-lg font-inter font-bold text-lia-text-primary dark:text-lia-text-primary">1.234</span>
              </div>
              <div className="w-full bg-gray-200 dark:bg-lia-bg-elevated rounded-full h-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-open-sans font-semibold text-lia-text-primary dark:text-lia-text-primary">Ofertas Enviadas</p>
                  <p className={`${textStyles.description} dark:text-lia-text-tertiary`}>18% conversão (total)</p>
                </div>
                <span className="text-lg font-inter font-bold text-lia-text-primary dark:text-lia-text-primary">585</span>
              </div>
              <div className="w-full bg-gray-200 dark:bg-lia-bg-elevated rounded-full h-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-open-sans font-semibold text-lia-text-primary dark:text-lia-text-primary">Contratações Finalizadas</p>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="p-3 bg-gray-50 dark:bg-lia-bg-secondary rounded-md border border-lia-border-subtle dark:border-lia-border-subtle">
              <div className="flex items-center justify-between mb-2">
                <div>
                  <p className="font-open-sans font-semibold text-lia-text-primary dark:text-lia-text-primary text-sm">LinkedIn Jobs</p>
 ...
 <Badge className="bg-gray-100 text-lia-text-primary dark:text-lia-text-secondary font-inter font-bold">
            ...
            <div className="p-3 bg-gray-50 dark:bg-lia-bg-secondary rounded-md border border-lia-border-subtle dark:border-lia-border-subtle">
              <div className="flex items-center justify-between mb-2">
                <div>
                  <p className="font-open-sans font-semibold text-lia-text-primary dark:text-lia-text-primary text-sm">Indicações Internas</p>
            ...
            <div className="p-3 bg-gray-50 dark:bg-lia-bg-secondary rounded-md border border-lia-border-subtle dark:border-lia-border-subtle">
              <div className="flex items-center justify-between mb-2">
                <div>
                  <p className="font-open-sans font-semibold text-lia-text-primary dark:text-lia-text-primary text-sm">Site Corporativo</p>
            ...
            <div className="p-3 bg-gray-50 dark:bg-lia-bg-secondary rounded-md border border-lia-border-subtle dark:border-lia-border-subtle">
              <div className="flex items-center justify-between mb-2">
                <div>
                  <p className="font-open-sans font-semibold text-lia-text-primary dark:text-lia-text-primary text-sm">Job Boards (Catho, Vagas.com)</p>
            ...
            <div className="p-3 bg-gray-50 dark:bg-lia-bg-secondary rounded-md border border-lia-border-subtle dark:border-lia-border-subtle">
              <div className="flex items-center justify-between mb-2">
                <div>
                  <p className="font-open-sans font-semibold text-lia-text-primary dark:text-lia-text-primary text-sm">Headhunting Especializado</p>
        ...
        <Card className={`${cardStyles.default} dark:bg-lia-bg-primary dark:border-lia-border-subtle`}>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="p-4 bg-status-success/10 dark:bg-status-success/20 rounded-md">
              <div className="flex items-center justify-between mb-2">
                <p className="text-sm font-open-sans font-semibold text-lia-text-primary dark:text-lia-text-primary">Taxa de Aceitação de Ofertas</p>
 ...
 <div className="p-4 bg-gray-50 dark:bg-lia-bg-secondary rounded-md">
              <div className="flex items-center justify-between mb-2">
                <p className="text-sm font-open-sans font-semibold text-lia-text-primary dark:text-lia-text-primary">Tempo Médio de Fechamento</p>
 <div className="text-2xl font-inter font-bold text-lia-text-primary dark:text-lia-text-secondary">21<span className="text-sm">d</span></div>
              </div>
              <div className="w-full bg-gray-200 dark:bg-lia-bg-elevated rounded-full h-2">
            ...
            <div className="p-4 bg-wedo-purple/10 dark:bg-wedo-purple/20 rounded-md">
              <div className="flex items-center justify-between mb-2">
                <p className="text-sm font-open-sans font-semibold text-lia-text-primary dark:text-lia-text-primary">Satisfação dos Contratados (30 dias)</p>
            ...
            <div className="p-4 bg-wedo-orange/10 dark:bg-wedo-orange/20 rounded-md">
              <div className="flex items-center justify-between mb-2">
                <p className="text-sm font-open-sans font-semibold text-lia-text-primary dark:text-lia-text-primary">Retenção em 90 dias</p>
