    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-2.5">
        <Card className={`${cardStyles.default} dark:bg-lia-bg-primary dark:border-lia-border-subtle`}>
          <CardContent className="p-3">
            <div className="flex items-start justify-between mb-2">
              <p className={`${textStyles.bodySmall}`}>NPS Geral</p>
        ...
        <Card className={`${cardStyles.default} dark:bg-lia-bg-primary dark:border-lia-border-subtle`}>
          <CardContent className="p-3">
            <div className="flex items-start justify-between mb-2">
              <p className={`${textStyles.bodySmall}`}>Promotores</p>
              <CheckCircle className="w-3.5 h-3.5 text-wedo-green" />
            </div>
            <div className="text-xl font-inter font-bold text-lia-text-primary">72%</div>
        ...
        <Card className={`${cardStyles.default} dark:bg-lia-bg-primary dark:border-lia-border-subtle`}>
          <CardContent className="p-3">
            <div className="flex items-start justify-between mb-2">
              <p className={`${textStyles.bodySmall}`}>Neutros</p>
              <Activity className="w-3.5 h-3.5 text-lia-text-primary" />
            </div>
            <div className="text-xl font-inter font-bold text-lia-text-primary">23%</div>
            <p className={`${textStyles.bodySmall} mt-1`}>21 de 89 respostas</p>
          </CardContent>
        </Card>
        ...
        <Card className={`${cardStyles.default} dark:bg-lia-bg-primary dark:border-lia-border-subtle`}>
          <CardContent className="p-3">
            <div className="flex items-start justify-between mb-2">
              <p className={`${textStyles.bodySmall}`}>Detratores</p>
              <AlertTriangle className="w-3.5 h-3.5 text-wedo-magenta" />
            </div>
            <div className="text-xl font-inter font-bold text-lia-text-primary">5%</div>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-open-sans text-lia-text-primary">Promotores (9-10)</span>
              </div>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-open-sans text-lia-text-primary">Detratores (0-6)</span>
              </div>
