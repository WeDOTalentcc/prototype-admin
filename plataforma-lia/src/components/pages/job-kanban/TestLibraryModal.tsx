                  ...
                  <div className="bg-lia-bg-secondary rounded-md p-3 mb-3">
                    ...
                    <div className="mt-3 pt-3 border-t border-lia-border-subtle">
                      ...
                      <div className="flex items-end gap-1 h-8">
                        ...
                        <div className="flex-1 bg-lia-text-secondary rounded-t" style={{height: '30%'}} title="40-60%: 15%"></div>
                        <div className="flex-1 bg-lia-text-secondary rounded-t" style={{height: '60%'}} title="60-80%: 35%"></div>
                        <div className="flex-1 bg-lia-border-medium rounded-t" style={{height: '80%'}} title="80-100%: 45%"></div>
                      </div>
