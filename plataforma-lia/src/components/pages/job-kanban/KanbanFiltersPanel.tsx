    ...
    <div className="flex-shrink-0 w-72 transition-all duration-300">
      <Card className="h-[calc(100vh-12rem)] flex flex-col overflow-hidden border border-gray-200 dark:border-gray-700 rounded-md">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          {/* Status */}
          <div className="space-y-2">
            <label className="text-xs font-medium text-gray-800 dark:text-gray-200">Status</label>
          ...
          {/* Origem */}
          <div className="space-y-2">
            <label className="text-xs font-medium text-gray-800 dark:text-gray-200">Origem</label>
            <div className="space-y-1.5">
          ...
          {/* Modelo de Trabalho */}
          <div className="space-y-2">
            <label className="text-xs font-medium text-gray-800 dark:text-gray-200">Modelo de Trabalho</label>
            <div className="space-y-1.5">
