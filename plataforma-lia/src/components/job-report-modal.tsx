...
export function JobReportModal({ job, isOpen, onClose }: JobReportModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-start justify-center pt-4 pb-4 overflow-y-auto print:bg-white print:backdrop-blur-none print:pt-0 print:pb-0">
      <div className="w-full max-w-[830px] bg-white dark:bg-gray-900 rounded-md overflow-hidden flex flex-col my-auto print:max-w-none print:rounded-none print:shadow-none print:my-0">
        {/* Header - Alinhado com conteúdo A4 */}
        <div className="bg-gray-900 dark:bg-gray-800 text-white px-4 py-2 print:py-2 print:px-3 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="flex-1 overflow-y-auto bg-white max-h-[calc(100vh-120px)] print:bg-white print:max-h-none print:overflow-visible">
          <div 
            ref={reportRef} 
                    ...
                    <table className="w-full text-micro">
                      <thead className="bg-gray-50">
                        <tr>
                          ...
                          <th className="text-center py-1 px-1 font-medium text-gray-800 dark:text-gray-200">Cand.</th>
                          <th className="text-center py-1 px-1 font-medium text-gray-800 dark:text-gray-200">Qual.</th>
                          <th className="text-center py-1 px-1 font-medium text-gray-800 dark:text-gray-200">Cont.</th>
                          <th className="text-right py-1 px-1.5 font-medium text-gray-800 dark:text-gray-200">Custo</th>
                        </tr>
                      </thead>
                      <tbody>
                        {reportData.channelPerformance.map((channel) => (
                          <tr key={channel.channel} className="border-t border-gray-100">
                            ...
                            <td className="text-right py-1 px-1.5 text-gray-600">
