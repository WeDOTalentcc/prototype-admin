...
import {
  Search, Loader2,
  FileText, Lightbulb, Briefcase, Brain
} from "lucide-react"
...
export interface ArchetypeCreateTabProps {
  ...
  onOpenArchetypeFromJob: (job: JobSearchResult) => void
...
export function ArchetypeCreateTab({
...
interface CreateFromDescriptionProps {
  archetypeDescription: string
  onArchetypeDescriptionChange: (v: string) => void
  isCreatingArchetype: boolean
  onCreateArchetypeFromDescription: (description: string) => void
