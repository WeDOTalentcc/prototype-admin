      ...
      {aiSuggestedTags.length > 0 && (
        <div className="mt-2 p-2 rounded-md bg-wedo-cyan/8 border border-wedo-cyan/30">
          <div className="flex items-center gap-1.5 mb-1.5">
            ...
            <button type="button" onClick={() => { onAiSuggestedTagsChange([]); onSelectedAiTagsChange([]) }} className="ml-auto p-0.5 hover:bg-lia-bg-tertiary dark:hover:bg-lia-btn-primary-hover rounded-md">
