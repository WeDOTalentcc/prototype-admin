    ...
    <div className="space-y-4">
      ...
      <div className="bg-lia-bg-secondary/50 rounded-md p-4 border border-lia-border-subtle">
        ...
        <div className="grid grid-cols-5 gap-3">
          {[
            { Icon: GitBranch, label: "Pipeline LIA", value: liaFunnelMetrics.pipeline_lia, color: "text-lia-text-primary" },
                ...
                <div key={job.id} className="bg-lia-bg-primary rounded-md p-2.5 border border-lia-border-subtle">
                  ...
                  <div className="flex flex-wrap gap-1 mt-1.5">
                    {job.behavioral_competencies?.map((comp, i) => (
                      <span key={i} className="text-xs px-2 py-0.5 rounded-full bg-wedo-purple/15 text-wedo-purple">
                        {comp.competency}
                      </span>
                    ))}
                  </div>
                ...
                <div key={job.id} className="bg-lia-bg-primary rounded-md p-2.5 border border-lia-border-subtle">
                  ...
                  <div className="flex flex-wrap gap-1 mt-1.5">
                    {job.benefits?.map((benefit, i) => (
                      <span key={i} className="text-xs px-2 py-0.5 rounded-full bg-status-success/15 text-status-success">
                        {benefit}
                      </span>
                    ))}
                  </div>
