...
import {
  Eye, Info, CalendarDays, CheckCircle
} from"lucide-react"
import { textStyles, badgeStyles } from '@/lib/design-tokens'
import { sanitizeHtml } from"@/lib/sanitize"
import type { CommunicationChannel, CommunicationType, Candidate } from"./unified-communication-types"
...
function formatPreviewMessage(text: string) {
  return text
...
export function MessagePreviewPanel({ channel, type, subject, message, candidate }: MessagePreviewPanelProps) {
  return (
            ...
            <div>
              <div className="px-4 py-3 bg-lia-bg-secondary">
                ...
                <div className={textStyles.caption}>
                  Para: <span className="text-lia-text-primary">{candidate.email}</span>
                </div>
              </div>
