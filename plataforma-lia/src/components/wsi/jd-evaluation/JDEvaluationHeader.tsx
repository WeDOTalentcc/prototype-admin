      ...
      {evaluation && (
        <>
          ...
          {(() => {
            ...
            return (
              <div className="flex items-center gap-3 pb-2 border-b border-lia-border-subtle dark:border-lia-border-subtle px-3 pt-3">
          ...
          {evaluation.indicators.some(i => i.dimension) && (
            <div className="grid grid-cols-3 gap-1.5 pb-2 border-b border-lia-border-subtle dark:border-lia-border-subtle px-3 pt-2">
          ...
          {!evaluation.indicators.some(i => i.dimension) && (
            <div className="flex items-center gap-3 pb-2 border-b border-lia-border-subtle dark:border-lia-border-subtle flex-wrap px-3 pt-2">
              {evaluation.indicators.map((indicator) => (
