...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
 "mt-2 ring-offset-lia-bg-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lia-interactive-focus focus-visible:ring-offset-2 dark:ring-offset-lia-bg-primary",
      className
    )}
    {...props}
  />
