      ...
      {actions.map((action) => {
        ...
        return (
          <Button
            ...
            className={`inline-flex items-center gap-2 px-3 py-1.5 h-auto rounded-md text-xs font-medium font-['Open_Sans',sans-serif] transition-colors motion-reduce:transition-none duration-200 border-lia-border-default ${getVariantStyles(action.variant)}`}
          >
