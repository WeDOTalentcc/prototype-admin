    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        {editedCV.extraction_notes.length > 0 && (
          <div className="flex items-start gap-3 p-3 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md">
            <AlertCircle className="w-5 h-5 text-gray-600 dark:text-gray-400 flex-shrink-0 mt-0.5" />
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">
                Notas da extração
              </p>
              <ul className="text-xs text-gray-600 dark:text-gray-400/80 mt-1 space-y-0.5">
          ...
          <ScrollArea className="flex-1 mt-4">
            <TabsContent value="contact" className="space-y-4 m-0">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Linkedin className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-600" />
                    <Input
                      id="linkedin"
            ...
            <TabsContent value="experience" className="space-y-4 m-0">
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  <Briefcase className="w-4 h-4 text-gray-800 dark:text-gray-200" />
                ...
                {editedCV.experiences.length === 0 ? (
                  <p className="text-sm text-gray-800 dark:text-gray-200 italic">Nenhuma experiência extraída</p>
                ) : (
                  <div className="space-y-3">
              ...
              <div className="space-y-3 pt-4 border-t">
                <div className="flex items-center gap-2">
                  <GraduationCap className="w-4 h-4 text-gray-800 dark:text-gray-200" />
                ...
                {editedCV.education.length === 0 ? (
                  <p className="text-sm text-gray-800 dark:text-gray-200 italic">Nenhuma formação extraída</p>
                ) : (
                  <div className="space-y-3">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {editedCV.skills.map((skill) => (
                    <Badge key={skill} className="bg-gray-100 text-gray-800 dark:text-gray-200 px-2 py-1">
                      {skill}
                      <button
              ...
              <div className="space-y-3 pt-4 border-t">
                ...
                <div className="flex flex-wrap gap-2">
                  {editedCV.languages.length === 0 ? (
                    <p className="text-sm text-gray-800 dark:text-gray-200 italic">Nenhum idioma extraído</p>
                  ) : (
              ...
              <div className="space-y-3 pt-4 border-t">
                ...
                <div className="flex flex-wrap gap-2">
                  {editedCV.certifications.length === 0 ? (
                    <p className="text-sm text-gray-800 dark:text-gray-200 italic">Nenhuma certificação extraída</p>
                  ) : (
            ...
            <TabsContent value="additional" className="space-y-4 m-0">
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2 mb-2">
                  {tags.map((tag) => (
                    <Badge key={tag} className="bg-gray-100 text-gray-800 dark:text-gray-200 px-2 py-1">
              ...
              {editedCV.file_name && (
                <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-md text-xs text-gray-600 mt-4">
