...
function SuggestionBadge({ isNew }: { isNew: boolean }) {
  ...
  return (
    <Badge variant="outline" className="ml-2 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-50 border-gray-300 dark:border-gray-600 text-xs">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex flex-col items-end gap-2">
            ...
            {data.suggestions_count > 0 && (
              <Badge variant="outline" className="bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-50 border-gray-300 dark:border-gray-600">
                <Lightbulb className="w-3 h-3 mr-1" />
      ...
      <CardContent className="space-y-6">
        ...
        <div className="text-xs text-muted-foreground flex items-center gap-4">
          <span className="flex items-center gap-1">
            <Lightbulb className="w-3 h-3 text-gray-700 dark:text-gray-300" />
            = Sugerido pela LIA
          </span>
          <span className="flex items-center gap-1">
