          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center p-3 bg-wedo-purple/10 dark:bg-wedo-purple/20 rounded-md">
                <div className="text-sm font-medium text-wedo-purple-text dark:text-wedo-purple">Formato</div>
                <div className="text-xs text-wedo-purple-text dark:text-wedo-purple">Conversa estruturada</div>
              </div>
            </div>
          </CardContent>
        </Card>
