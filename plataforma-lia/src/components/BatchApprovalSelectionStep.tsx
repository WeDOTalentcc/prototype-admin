...
interface BatchApprovalSelectionStepProps {
  ...
  setFilterCriteria: (value: { stage: string; score: string; priority: string; department: string }) => void
...
export function BatchApprovalSelectionStep({
  filteredCandidates,
  selectedCandidates,
  searchTerm,
  setSearchTerm,
  ...
  getScoreColor,
  getPriorityColor,
}: BatchApprovalSelectionStepProps) {
  return (
