      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-xl font-sans font-semibold text-lia-text-primary mb-1">
                Dashboard Executivo
              </h1>
            ...
            <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                      {data.pendingActions.map((action, index) => (
                        ...
                        >
                          ...
                          <p className="text-xs text-lia-text-secondary">{action.message}</p>
                        </div>
                      ))}
                    </div>
                  </CardContent>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <Card className="bg-lia-bg-tertiary dark:bg-lia-bg-secondary">
                  <CardContent className="p-4">
                    ...
                    <div className="text-2xl font-bold text-lia-text-primary">{data.summary.activeJobs}</div>
                    <div className="text-xs text-lia-text-primary">Vagas Ativas</div>
                ...
                <Card className="bg-status-success/10 dark:bg-status-success/20">
                  <CardContent className="p-4">
                    ...
                    <div className="text-2xl font-bold text-lia-text-primary">{data.summary.totalCandidates.toLocaleString()}</div>
                    <div className="text-xs text-lia-text-primary">Candidatos no Período</div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-wedo-purple/10 dark:bg-wedo-purple/20">
                  <CardContent className="p-4">
                    ...
                    <div className="text-2xl font-bold text-lia-text-primary">{data.summary.totalHires}</div>
                    <div className="text-xs text-lia-text-primary">Contratações</div>
                    <div className="text-xs text-lia-text-secondary mt-1">
                ...
                <Card className="bg-wedo-orange/10 dark:bg-wedo-orange/20">
                  <CardContent className="p-4">
                    ...
                    <div className="text-2xl font-bold text-lia-text-primary">{data.summary.averageTimeToHire}d</div>
                    <div className="text-xs text-lia-text-primary">Tempo Médio de Contratação</div>
                    <div className="text-xs text-lia-text-secondary mt-1">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4 pt-3 flex justify-between text-sm">
                      <span className="text-lia-text-primary">Taxa de Conversão:</span>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-base font-sans flex items-center gap-2">
                      <Building className="w-5 h-5 text-lia-text-primary" />
                      Performance por Departamento
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                      ...
                      {data.departmentMetrics.map((dept, index) => (
                        <div key={dept.department} className="flex items-center gap-3 p-2 rounded-md hover:bg-lia-bg-secondary dark:hover:bg-lia-btn-primary-hover">
                          ...
                          <div className="flex-1 grid grid-cols-4 gap-2 text-center text-xs">
                            <div>
                              <div className="font-bold text-lia-text-primary">{dept.jobs}</div>
                              <div className="text-lia-text-secondary">vagas</div>
                            </div>
                            <div>
                              <div className="font-bold text-lia-text-primary">{dept.candidates}</div>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {data.riskFactors.map((risk, index) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          <span className="font-medium text-sm text-lia-text-primary">{risk.factor}</span>
