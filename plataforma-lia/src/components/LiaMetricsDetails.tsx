...
export function LiaMetricsDetails({
  contactRate,
  ...
  return (
    <>
      ...
      <LiaMetricsSLA
        ...
        triageConversionRate={triageConversionRate}
        triageApprovalRate={triageApprovalRate}
        interviewConversionRate={interviewConversionRate}
        avgLiaScore={avgLiaScore}
        avgSkillsMatch={avgSkillsMatch}
        avgTimeContact={avgTimeContact}
        avgTimeTriage={avgTimeTriage}
        avgTimeInterview={avgTimeInterview}
