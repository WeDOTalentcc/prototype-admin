  ...
  return (
    <div className="px-4 py-6 flex flex-col items-center gap-4">
      ...
      {d.handoff_url && (
        <a
          href={d.handoff_url}
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-md bg-wedo-cyan text-white text-sm font-medium hover:bg-wedo-cyan/90 transition-colors motion-reduce:transition-none font-['Open_Sans',sans-serif]"
        >
