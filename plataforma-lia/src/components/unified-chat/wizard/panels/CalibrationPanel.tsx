      ...
      <div className="px-4 py-2.5 border-b border-lia-border-subtle">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {poolCount !== null && (
              <span className="flex items-center gap-1 text-[10px] text-lia-text-secondary font-medium">
        ...
        {hasCriteria && (
          <button
            ...
            className="mt-2 inline-flex items-center gap-1 text-[11px] font-medium text-lia-text-secondary hover:underline transition-colors motion-reduce:transition-none"
          >
          ...
          <div className="flex items-center gap-1.5">
            ...
            {candidate.linkedin_url && (
              <a
                ...
                className="text-[10px] text-lia-text-muted hover:underline flex-shrink-0"
            ...
            return (
              <tr key={i} className="hover:bg-lia-bg-secondary/50 transition-colors">
                ...
                <td className="py-1.5 text-right">
                  <button
                    type="button"
                    className="inline-flex items-center gap-0.5 text-[10px] text-lia-text-muted hover:underline"
