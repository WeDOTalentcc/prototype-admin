...
interface GoalsTemplateSelectModalProps {
  onClose: () => void
  users: GoalsMgmtUser[]
  ...
  setTemplateApplyMode: (mode: 'all' | 'selected') => void
  searchTerm: string
  ...
  setHiddenTemplates: React.Dispatch<React.SetStateAction<Set<string>>>
  ...
  setEditingTemplate: (template: GoalTemplate | null) => void
}

export function GoalsTemplateSelectModal({
  onClose,
  users,
  selectedUser,
  selectedTemplateIds,
