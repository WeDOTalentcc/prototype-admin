/**
 * @deprecated Sprint 2 Integrations UX rework (2026-05-27).
 *
 * Replaced by IntegrationDetailModal.tsx (Dialog/centered modal).
 * This Sheet-based drawer is kept for safety — will be deleted in a follow-up cleanup.
 *
 * DO NOT add new features here. Use IntegrationDetailModal instead.
 */
"use client"
...
// Sheet import removed — this file is @deprecated.
// See IntegrationDetailModal.tsx for the canonical Dialog-based replacement.
// Type-stubs below keep TS happy during the deprecation window.
const Sheet = (_p: Record<string, unknown>) => null
const SheetContent = (_p: Record<string, unknown>) => null
const SheetHeader = (_p: Record<string, unknown>) => null
const SheetTitle = (_p: Record<string, unknown>) => null
const SheetDescription = (_p: Record<string, unknown>) => null
