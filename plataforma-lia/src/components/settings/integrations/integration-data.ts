...
export const integrations: Integration[] = [
  ...
  },
  {
    ...
    iconColor: "text-wedo-green-bright",
    iconLetter: "Pp",
    connectAction: "config",
    capabilities: [
  ...
  },
  {
    ...
    category: "communication",
    status: "coming_soon",
    iconBg: "bg-wedo-amber/10",
    iconColor: "text-wedo-amber",
    iconLetter: "E",
    connectAction: "none",
    capabilities: [
