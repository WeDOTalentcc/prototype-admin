...
export function HiringPoliciesHub() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Sprint B Phase 2 — Learning Loops configuration */}
      <div className="mt-6 bg-lia-bg-primary dark:bg-lia-bg-secondary rounded-xl p-4 border border-lia-border-subtle">
        <LearningLoopsPanel />
      </div>
    </div>
  )
