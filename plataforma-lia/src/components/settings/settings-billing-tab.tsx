...
export function SettingsBillingTab({ onSettingsChange }: { onSettingsChange: (changed: boolean) => void }) {
 ...
 case "trial": return "bg-lia-bg-secondary text-lia-text-primary dark:bg-lia-bg-secondary"
      case "suspenso": return "bg-status-error/15 text-status-error dark:bg-status-error/20 dark:text-status-error"
      default: return "bg-lia-bg-tertiary text-lia-text-primary dark:bg-lia-bg-elevated"
    }
  }
        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 border border-lia-border-default dark:border-lia-border-default rounded-md bg-lia-bg-primary dark:bg-lia-bg-secondary w-64"
            />
          </div>
        ...
        {mockClients.map((client) => (
          <Card key={client.id} className="hover:transition-shadow">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-lia-bg-tertiary dark:bg-lia-bg-elevated rounded-md flex items-center justify-center">
 ...
 ? 'bg-lia-bg-secondary dark:bg-lia-bg-secondary text-lia-text-primary'
      ...
      {showSendInviteModal && selectedClient && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-lia-bg-primary dark:bg-lia-bg-secondary rounded-md w-full max-w-lg p-6">
            <div className="flex items-center justify-between mb-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  disabled
                  className="w-full p-2 border border-lia-border-default dark:border-lia-border-default rounded-md bg-lia-bg-secondary dark:bg-lia-bg-elevated"
                />
              </div>
              <div>
