...
import {
  Plus, Edit, X, BarChart3, CheckCircle, Loader2, Search
} from "lucide-react"
import { textStyles } from "@/lib/design-tokens"
import { getCategoryIcon, getCategoryColor } from "./goals"
import type { GoalTemplate, UserGoal } from "./goals-management-types"
...
interface GoalsTemplatesModalProps {
  ...
  setSelectedTemplateIds: (v: Set<string>) => void
  setSearchTerm: (v: string) => void
  setFilterCategory: (v: string) => void
  setFilterPeriod: (v: string) => void
  setTemplateApplyMode: (v: 'all' | 'selected') => void
  setHiddenTemplates: (v: Set<string>) => void
  setEditingTemplate: (v: GoalTemplate | null) => void
...
export function GoalsTemplatesModal({
  users, selectedUser, searchTerm, filterCategory, filterPeriod,
  selectedTemplateIds, templateApplyMode, isSaving, hiddenTemplates,
  filteredTemplates, userGoalsMap,
  setShowTemplates, setSelectedTemplateIds, setSearchTerm, setFilterCategory,
  setFilterPeriod, setTemplateApplyMode, setHiddenTemplates, setEditingTemplate,
  handleApplySelectedTemplates, toggleTemplateSelection, isTemplateAppliedToUser
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <div className="flex items-center gap-0.5">
                      ...
                      <Button
                        ...
                        onClick={(e) => {
                          e.stopPropagation()
                          setHiddenTemplates(new Set([...hiddenTemplates, template.id]))
                        }}
