...
import { ThinkingDots } from "@/components/ui/thinking-dots"
  ...
  import { useWizardState } from './expanded-chat/hooks'
  import { type ExpandedChatModalProps, type Message } from './expanded-chat/types'
  import { ChatMessageList, ExpandedChatInput, WizardRightPanel } from './expanded-chat/components'
  ...
  import { useExpandedChatModalCore } from './expanded-chat/hooks/useExpandedChatModalCore'

  function ExpandedChatModalContent(props: ExpandedChatModalProps) {
    const {
      inline = false,
      onClose,
      onMinimize,
    ...
    globalSearchAuthorized, goToNextStage, goToPreviousStage, handleApproveCandidate, handleClearDraftAndReset, handleFastTrackVacancySelect, handleFileAnalysisComplete, handleFileAnalysisError,
    handleFileSelect, handleKeyDown, handleProactiveAccept, handleProactiveReject, handlePublishJob, handleRejectCandidate, handleSendMessage, handleVoiceResponse,
    hasAttemptedCalibrationGeneration, hasConfigData, hasPendingChanges, hasRestoredDraft, highlightedFields, inputRef, inputValue, isAutoSaving,
    isFieldRequiredForWizard, isFullscreen, isGeneratingDescription, isGeneratingWSI, isHighlighted, isInJobCreationMode, isJobCreationMode, isLoading,
    isLoadingBenchmark, isLoadingCalibration, isLoadingEnrichment, isPanelOpen, isSearchingVacancies, isTypingEffect, jobConfig, jobDescription,
    localCandidateCount, messages, messagesEndRef, newBenefitName, newBenefitValue, newCompetencyJustification, newCompetencyName, newSkillCategory,
    newSkillName, panelWidth, preferredCandidateCount, publishedJobId, publishingPlatforms, removeCalibrationCriterion, resizeRef, salaryBenchmark,
    salaryInfo, salaryPanelExpanded, searchPhase, setActiveInputTab, setActiveToolConfirmationMessageId, setAwaitingDraftChoice, setAwaitingFastTrackSelection, setBehavioralCompetencies,
    setCalibrationComment, setCalibrationComplete, setCandidateProfileTab, setCompanyDefaultQuestions, setCompetenciesPanelExpanded, setCompetenciesTab, setCompetencySuggestions, setCurrentCalibrationIndex,
    setCurrentStage, setCustomQuestionRequired, setCustomQuestionText, setCustomQuestionType, setDetectedCriteria, setDisplayedText, setDynamicInitialMessage, setEditingCompetency,
    setEnrichedJDData, setFastTrackState, setGlobalSearchAuthorized, setHasAttemptedCalibrationGeneration, setInputValue, setInternalJobCreationMode, setIsFullscreen, setIsLoading,
    setIsPanelOpen, setIsResizing, setJobConfig, setMessages, setNewBenefitName, setNewBenefitValue, setNewCompetencyJustification, setNewCompetencyName,
    setNewSkillCategory, setNewSkillName, setPendingDraftData, setPreferredCandidateCount, setPublishingPlatforms, setSalaryInfo, setSalaryPanelExpanded, setSearchPhase,
    setShowAddBenefitModal, setShowAddCompetencyModal, setShowAddSkillModal, setShowCalibrationModal, setShowClearDraftConfirm, setShowCustomQuestionForm, setShowEditCriteriaModal, setShowMoreIdeas,
    setShowSkipCompetenciesWarning, setShowUploadModal, setTechnicalSkills, setUploadedFile, showAddBenefitModal, showAddCompetencyModal, showAddSkillModal, showCalibrationModal,
    showClearDraftConfirm, showCustomQuestionForm, showEditCriteriaModal, showMoreIdeas, showSkipCompetenciesWarning, showUploadModal, stageTransition, startGlobalSearch,
    technicalSkills, toggleWSIQuestionSelection, toolCalling, trackFieldChange, typeText, updateLanguages, updateWSIQuestionCorrectOption, updateWSIQuestionExpectedAnswer,
    wizardGreeting, wizardMode, wsiCandidates, wsiQualityGates, wsiQuestions,
    isOpen,
  } = useExpandedChatModalCore(props)
          ...
          {isInJobCreationMode && !isPanelOpen && wizardMode === 'create_from_scratch' && (
            <div className="flex items-start pt-4 px-1 flex-shrink-0 ml-auto pr-4">
              <Button
                ...
                className="h-7 px-2 text-lia-text-secondary hover:text-lia-text-secondary hover:bg-lia-bg-tertiary gap-1"
