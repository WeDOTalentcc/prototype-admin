...
import { SalaryStage, CompetenciesStage, WSIQuestionsStage, EnrichedJDStage, SearchCalibrationStage, SearchCalibrationNavButtons, type EnrichedJDData } from './expanded-chat/stages'
import {
  parseCommand,
  isLocalCommand,
  getStageLabel,
