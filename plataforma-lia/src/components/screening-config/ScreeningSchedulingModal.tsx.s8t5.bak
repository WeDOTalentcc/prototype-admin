          ...
          <div className={`space-y-3 ${!autoEnabled ? 'opacity-50 pointer-events-none' : ''}`}>
            ...
            <div className="space-y-2">
              ...
              <Select value={calendarProvider} onValueChange={setCalendarProvider}>
                <SelectTrigger className="h-9 text-xs border-gray-200 dark:border-gray-600">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <Label className="text-xs font-medium text-gray-950 dark:text-gray-50">Horários Disponíveis</Label>
              </div>
              <Input
