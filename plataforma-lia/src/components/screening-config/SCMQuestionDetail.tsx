  ...
  return (
    <div className="flex-1 min-w-0">
      <div className="flex items-center gap-1.5 mb-2 flex-wrap">
        <Badge className={`text-micro px-2 py-0.5 h-5 rounded-full ${item.category === 'behavioral' || item.category === 'Comportamental' || item.category === 'comportamental' ? 'bg-wedo-purple/15 text-wedo-purple border border-wedo-purple/30 dark:bg-wedo-purple/20 dark:text-wedo-purple dark:border-wedo-purple/30' : item.category === 'technical' || item.category === 'Técnica' || item.category === 'técnica' ? 'bg-wedo-cyan/10 text-wedo-cyan-dark border border-wedo-cyan/30 dark:text-wedo-cyan-dark dark:border-wedo-cyan/30' : item.category === 'cultural' || item.category === 'fit_cultural' ? 'bg-wedo-cyan/10 text-wedo-cyan border border-wedo-cyan/30 dark:bg-wedo-cyan/20 dark:text-wedo-cyan dark:border-wedo-cyan/30' : 'bg-status-success/15 text-status-success border border-status-success/30 dark:bg-status-success/20 dark:text-status-success dark:border-status-success/30'}`}>
      ...
      <button className="mt-1.5 text-micro lia-text-secondary hover:lia-text-base dark:hover:lia-text-muted transition-colors motion-reduce:transition-none" onClick={() => onToggleDetails(item.id)}>
