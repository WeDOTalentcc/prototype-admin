          ...
          <html>
            <head>
              ...
              <style>
                ...
                h1 { color: var(--lia-text-primary); }
                table { width: 100%; border-collapse: collapse; margin-top: 20px; }
                th, td { border: 1px solid var(--lia-border-subtle); padding: 8px; text-align: left; }
                th { background-color: var(--lia-btn-primary-bg); color: white; }
                .kpi-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; margin-bottom: 24px; }
                .kpi-card { border: 1px solid var(--lia-border-subtle); border-radius: 8px; padding: 16px; }
              </style>
            </head>
            <body>
 ...
 recruiter.rank === 1 ? 'bg-status-warning/10 text-status-warning' :
                      ...
                      <td className="py-3 px-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium text-lia-text-primary">{recruiter.recruiter_name}</span>
                        </div>
                      </td>
                      <td className="py-3 px-2 text-center">
                        <div className="flex items-center justify-center gap-1">
                          <span className={isOnTarget ? 'text-status-success font-bold' : 'text-lia-text-primary'}>
