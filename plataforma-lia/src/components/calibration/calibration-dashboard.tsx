...
export function CalibrationDashboard() {
  ...
  const getAccuracyColor = (accuracy: number) => {
    if (accuracy >= 90) return "text-lia-text-secondary"
  ...
  const getDivergenceIcon = (type: string) => {
    switch (type) {
      case "implicit_reject":
        return <TrendingDown className="w-4 h-4 text-lia-text-primary" />
      case "implicit_advance":
        return <TrendingUp className="w-4 h-4 text-lia-text-secondary" />
      case "explicit_disagree":
        return <ThumbsDown className="w-4 h-4 text-lia-text-secondary" />
      default:
        return <AlertTriangle className="w-4 h-4 text-lia-text-secondary" />
    }
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Scale className="w-5 h-5 text-lia-text-secondary" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="bg-gray-50 dark:bg-lia-bg-secondary/50">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-lia-text-secondary">Precisão LIA</p>
        ...
        <Card className="">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-lia-text-secondary">Taxa de Concordância</p>
              ...
              <ThumbsUp className="w-8 h-8 text-lia-text-secondary opacity-50" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-lia-text-secondary">Divergências</p>
                <p className="text-2xl font-bold text-lia-text-primary">
        ...
        <Card className="">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-lia-text-secondary">Ações Capturadas</p>
                <p className="text-2xl font-bold text-lia-text-primary">
              ...
              <Target className="w-8 h-8 text-lia-text-secondary opacity-50" />
            </div>
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent>
            {data.divergences.length === 0 ? (
              <div className="text-center py-8 text-lia-text-secondary">
                <CheckCircle className="w-12 h-12 mx-auto mb-2 text-lia-text-secondary opacity-50" />
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {divergence.feedback_reason && (
                        <p className="text-xs text-lia-text-primary mt-1 italic">
                          "{divergence.feedback_reason}"
                        </p>
                      )}
                    </div>
              ...
              {data.weights.map((weight) => (
                <div key={weight.id}>
                  <div className="flex justify-between items-center mb-1">
                    <span className="text-sm text-lia-text-primary capitalize">
          ...
          {selectedSuggestion && (
            <div className="space-y-4">
              ...
              {selectedSuggestion.supporting_evidence && (
                <div>
                  <p className="text-sm font-medium text-lia-text-primary mb-2">
                    Evidências:
                  </p>
              ...
              {selectedSuggestion.dimension && (
                <div className="flex items-center gap-4 p-3 bg-gray-100 dark:bg-lia-bg-secondary rounded-md">
                  ...
                  <div>
                    <p className="text-xs text-lia-text-secondary">Peso Sugerido</p>
                    <p className="text-lg font-bold text-lia-text-primary">
