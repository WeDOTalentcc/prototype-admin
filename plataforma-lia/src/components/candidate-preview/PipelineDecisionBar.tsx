    ...
    <div className="rounded-lg px-3 py-2 bg-lia-bg-primary space-y-2">
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="relative flex-shrink-0" ref={flyoutRef}>
          ...
          {showMoveDropdown && (
            <div className="absolute top-full right-0 mt-1 bg-lia-bg-primary border border-lia-border-subtle rounded-xl shadow-lg z-50 min-w-[200px] py-1 max-h-72 overflow-y-auto">
              {pipeline.filter(s => s.name !== canonicalStage).map((stage, idx) => (
                ...
                >
                  ...
                  {hoveredStageIdx === idx && !!stage.sub_statuses?.length && (
                    <div className="absolute top-0 right-full mr-0.5 bg-lia-bg-primary border border-lia-border-subtle rounded-xl shadow-lg z-50 min-w-[220px] py-1 max-h-64 overflow-y-auto">
                      <button
