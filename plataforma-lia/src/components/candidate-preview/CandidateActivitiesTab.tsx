                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-1.5">
                      {activity.score && (
                        <Chip variant={activity.score < 60 ? 'danger' : 'neutral'} muted className={`text-micro px-1.5 py-0 h-4 ${activity.score >= 80 ? 'bg-lia-bg-tertiary text-lia-text-primary border-lia-border-default' : activity.score >= 60 ? 'bg-lia-bg-tertiary text-lia-text-primary border-lia-border-subtle font-medium' : 'font-medium'}`}>
