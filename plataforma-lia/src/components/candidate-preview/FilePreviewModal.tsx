      ...
      <div className="bg-white dark:bg-lia-bg-primary rounded-md max-w-4xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-3 border-b border-lia-border-subtle dark:border-lia-border-subtle bg-white dark:bg-lia-bg-primary">
          <div className="flex items-center gap-2">
            {previewType === 'pdf' && <FileText className="w-4 h-4 text-lia-text-primary dark:text-lia-text-primary" />}
            {previewType === 'image' && <Image className="w-4 h-4 text-lia-text-primary dark:text-lia-text-primary" />}
            {previewType === 'video' && <FileVideo className="w-4 h-4 text-status-error" />}
            {previewType === 'audio' && <Mic className="w-4 h-4 text-lia-text-tertiary dark:text-lia-text-tertiary" />}
          ...
          <div className="flex items-center gap-2">
            ...
            {previewType === 'pdf' && (
              <>
                <div className="flex items-center gap-1 bg-gray-100 dark:bg-lia-bg-secondary rounded-md px-2 py-1">
                  ...
                  <span className="text-xs text-lia-text-secondary dark:text-lia-text-tertiary px-1">
            ...
            {previewType === 'image' && (
              <div className="flex items-center gap-1">
                ...
                <span className="text-xs text-lia-text-secondary dark:text-lia-text-tertiary w-10 text-center">
                  {imageZoom}%
                </span>
          ...
          {previewType === 'pdf' && (
            <div className="bg-gray-100 dark:bg-lia-bg-secondary rounded-md p-6 min-h-[600px] flex items-center justify-center">
              <div className="text-center">
                <FileText className="w-16 h-16 text-lia-text-secondary dark:text-lia-text-tertiary mx-auto mb-3" />
                <p className="text-lia-text-secondary dark:text-lia-text-tertiary mb-2">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="col-span-2">
                <div className="bg-black rounded-md aspect-video flex items-center justify-center">
                  <div className="text-center">
                    <FileVideo className="w-16 h-16 text-lia-text-secondary dark:text-lia-text-tertiary mx-auto mb-3" />
                    <p className="text-white mb-2">
                      {videoPlaying ? 'Reproduzindo vídeo...' : 'Clique para reproduzir'}
                    </p>
                    <p className="text-lia-text-secondary dark:text-lia-text-tertiary text-sm">
                      {selectedFile.name}
                    </p>
                  </div>
                </div>
                ...
                {selectedFile.videoType === 'prescreening' && (
                  <div className="mt-4 bg-white dark:bg-lia-bg-secondary rounded-md p-3">
                    <h4 className="text-xs font-medium text-lia-text-primary dark:text-lia-text-primary mb-2 flex items-center gap-1">
                      <MessageSquareText className="w-3.5 h-3.5 text-lia-text-primary dark:text-lia-text-primary" />
                ...
                <div className="mt-4 bg-white dark:bg-lia-bg-secondary rounded-md p-3">
                  ...
                  <div className="grid grid-cols-4 gap-2 mb-3">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm font-bold text-lia-text-primary dark:text-lia-text-primary">95%</p>
                    </div>
                    <div className="text-center">
                      <p className={textStyles.bodySmall}>Clareza</p>
                      <p className="text-sm font-bold text-lia-text-primary dark:text-lia-text-primary">88%</p>
                    </div>
                    <div className="text-center">
                      <p className={textStyles.bodySmall}>Entusiasmo</p>
                      <p className="text-sm font-bold text-lia-text-primary dark:text-lia-text-primary">90%</p>
                    </div>
                  </div>
                  ...
                  <div className="border-t border-lia-border-subtle dark:border-lia-border-subtle pt-3">
                    ...
                    <div className="space-y-2 text-xs text-lia-text-secondary dark:text-lia-text-tertiary">
                      <p>
                        <span className="font-semibold text-lia-text-primary dark:text-lia-text-primary">Pontos Fortes:</span> O candidato demonstra excelente capacidade de comunicação,
                      ...
                      <p>
                        <span className="font-semibold text-lia-text-primary dark:text-lia-text-primary">Pontos de Atenção:</span> Poderia ter elaborado mais sobre metodologias
                        específicas de design. A resposta sobre trabalho em equipe foi um pouco genérica.
                      </p>
                      <p>
                        <span className="font-semibold text-lia-text-primary dark:text-lia-text-primary">Recomendação:</span> Candidato altamente recomendado para próxima fase.
              ...
              <div className="col-span-1">
                <div className="bg-white dark:bg-lia-bg-secondary rounded-md p-3 h-full overflow-y-auto">
                  <h4 className="text-xs font-medium text-lia-text-primary dark:text-lia-text-primary mb-3 sticky top-0 bg-lia-bg-primary pb-2 border-b border-lia-border-subtle dark:border-lia-border-subtle">
                    📝 Transcrição
                  </h4>
                  ...
                  <div className="space-y-3 text-xs">
                    {selectedFile.transcript && selectedFile.transcript.length > 0 ? (
                      ...
                      <div className="text-center py-4 text-lia-text-secondary dark:text-lia-text-tertiary">
                    ...
                    {selectedFile.highlights && selectedFile.highlights.length > 0 && (
                      <div className="mt-4 p-2 bg-white dark:bg-lia-bg-secondary rounded-md">
                        <p className="text-xs font-semibold text-lia-text-primary dark:text-lia-text-primary mb-1">
                          🎯 Highlights da LIA
                        </p>
                        <ul className="space-y-1 text-xs text-lia-text-secondary dark:text-lia-text-tertiary">
              ...
              <div className="col-span-2">
                  ...
                  <div className="text-center w-full">
                    <div className="flex items-center justify-center mb-3">
                      <div className="w-16 h-16 rounded-full bg-gray-200 dark:bg-lia-bg-elevated flex items-center justify-center">
                        <Mic className="w-8 h-8 text-lia-text-secondary dark:text-lia-text-tertiary" />
                      </div>
                    </div>
                    <p className="text-lia-text-primary dark:text-lia-text-primary mb-2">
                      {audioPlaying ? 'Reproduzindo áudio...' : 'Clique para reproduzir'}
                    </p>
                    <p className="text-lia-text-tertiary dark:text-lia-text-tertiary text-sm mb-3">
                      {selectedFile.name}
                    </p>
                    {/* Barra de progresso */}
                    <div className="flex items-center gap-3 max-w-md mx-auto">
                      ...
                      <span className="text-xs text-lia-text-secondary dark:text-lia-text-tertiary font-mono w-20 text-right">
                ...
                <div className="mt-4 bg-white dark:bg-lia-bg-secondary rounded-md p-3">
                  ...
                  <div className="grid grid-cols-4 gap-2 mb-3">
                    <div className="text-center">
                      <p className={textStyles.bodySmall}>Clareza</p>
                      <p className="text-sm font-bold text-lia-text-primary dark:text-lia-text-primary">94%</p>
                    </div>
                    <div className="text-center">
                      <p className={textStyles.bodySmall}>Confiança</p>
                      <p className="text-sm font-bold text-lia-text-primary dark:text-lia-text-primary">91%</p>
                    </div>
                    <div className="text-center">
                      <p className={textStyles.bodySmall}>Conhecimento</p>
                      <p className="text-sm font-bold text-lia-text-primary dark:text-lia-text-primary">96%</p>
                    </div>
                    <div className="text-center">
                      <p className={textStyles.bodySmall}>Comunicação</p>
                      <p className="text-sm font-bold text-lia-text-primary dark:text-lia-text-primary">89%</p>
                    </div>
                  </div>
                  ...
                  <div className="border-t border-lia-border-subtle dark:border-lia-border-subtle pt-3">
                    ...
                    <div className="space-y-2 text-xs text-lia-text-secondary dark:text-lia-text-tertiary">
                      <p>
                        <span className="font-semibold text-lia-text-primary dark:text-lia-text-primary">Pontos Fortes:</span> O candidato demonstra excelente articulação e domínio técnico.
                        Experiência sólida em liderança de times mobile, com resultados mensuráveis (redução de 40% no tempo de desenvolvimento).
                      </p>
                      <p>
                        <span className="font-semibold text-lia-text-primary dark:text-lia-text-primary">Pontos de Atenção:</span> Poderia detalhar mais sobre gestão de conflitos e metodologias ágeis.
