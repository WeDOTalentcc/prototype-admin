...
export const AGENT_TEMPLATES: AgentTemplate[] = [
  {
    ...
    allowed_tools: ["search_candidates", "get_candidate_details", "get_evaluation_criteria"],
  ...
  },
  {
    ...
    allowed_tools: ["get_candidate_details", "get_evaluation_criteria"],
    context_level: "full",
    max_steps: 8,
    temperature: 0.5,
    enable_memory: true,
  ...
  },
  {
    ...
    allowed_tools: ["search_candidates", "get_candidate_details", "get_job_details"],
    context_level: "standard",
    max_steps: 10,
    temperature: 0.4,
    enable_memory: true,
  ...
  },
  {
    ...
    allowed_tools: ["list_jobs", "get_pipeline_summary"],
    context_level: "standard",
    max_steps: 8,
    temperature: 0.3,
    enable_memory: false,
  ...
  },
  {
    ...
    allowed_tools: ["get_candidate_details", "get_job_details", "get_evaluation_criteria", "get_pipeline_summary"],
    context_level: "full",
    max_steps: 10,
    temperature: 0.3,
    enable_memory: true,
  ...
  },
  {
    ...
    allowed_tools: ["get_job_details", "list_jobs"],
    context_level: "standard",
    max_steps: 8,
    temperature: 0.7,
    enable_memory: true,
  ...
  },
  {
    ...
    allowed_tools: ["get_candidate_details", "send_email"],
    context_level: "standard",
    max_steps: 8,
    temperature: 0.5,
    enable_memory: true,
  ...
  },
  {
    ...
    allowed_tools: ["get_candidate_details", "get_job_details"],
    context_level: "standard",
    max_steps: 10,
    temperature: 0.4,
    enable_memory: true,
  ...
  },
  {
    ...
    allowed_tools: ["get_job_details", "get_candidate_details", "get_evaluation_criteria", "get_pipeline_summary"],
    context_level: "full",
    max_steps: 8,
    temperature: 0.2,
    enable_memory: false,
