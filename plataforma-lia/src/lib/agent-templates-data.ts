...
export const AGENT_TEMPLATES: AgentTemplate[] = [
  ...
  },
  {
    ...
    allowed_tools: ["get_candidate_details", "get_job_details", "get_evaluation_criteria"],
    context_level: "full",
    max_steps: 10,
    temperature: 0.3,
    enable_memory: true,
  ...
  },
  {
    ...
    allowed_tools: ["get_job_details", "get_candidate_details", "get_evaluation_criteria"],
    context_level: "full",
    max_steps: 8,
    temperature: 0.2,
    enable_memory: false,
