/**
 * Recruitment Stages and Sub-Statuses Constants
 * 
 * This file mirrors the backend structure from:
 * lia-agent-system/app/models/recruitment_stages.py
 * 
 * Maintains consistency between frontend and backend for:
 * - ATS integration with client systems
 * - Standardized nomenclature
 * - Kanban column definitions
 * 
 * Reference: docs/CANDIDATE_STATUS_REFERENCE.md
 */
...
export function mapLegacyStage(legacyStatus: string): string {
  const mapping: Record<string, string> = {
    ...
    'tecnica': 'interview_technical',
    'technical': 'interview_technical',
    'gestor': 'interview_manager',
    'manager': 'interview_manager',
