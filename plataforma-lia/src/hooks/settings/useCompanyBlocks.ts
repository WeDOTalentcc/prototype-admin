...
export function buildBlocks(
  ...
  const policyFields: CardField[] = [
    ...
    { key: "allowed_days", label: "Em quais dias da semana podemos contatar candidatos?", value: sr?.allowed_days ?? null, type: "list", editable: true, block: "policy" },
    { key: "allowed_hours", label: "Em qual janela horária podemos enviar comunicações?", value: hours ? `${hours.start || ""} - ${hours.end || ""}` : null, type: "time-range", editable: true, block: "policy" },
