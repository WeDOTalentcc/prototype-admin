...
description: Padronização visual de componentes React+Tailwind conforme Design System LIA v4.2.1. Use ao criar telas, componentes, modais, botões ou qualquer elemento novo de UI. Aplica regra 90/10, tipografia (Open Sans 85% + Inter 10% + JetBrains Mono 5%), tokens canônicos, dark mode e validação automática por grep.
---
...
**Sidebar:** `w-64 h-screen bg-white border-r border-gray-200 p-4 dark:bg-[#0F1113] dark:border-gray-800`
...
| Cor | Hex | Uso EXCLUSIVO |
|-----|-----|---------------|
| Cyan | #60BED1 | Brain icon LIA, badges LIA, sparkles |
| Green | #5DA47A | Candidatos, sucesso |
| Orange | #D19960 | Tempo, urgência |
| Purple | #9860D1 | Insights, IA |
| Magenta | #D160AB | Crítico, prioridade alta |
| Amber | #F59E0B | Warning vibrante |
...
| `shadow-lg` | Modais |
| `shadow-xl` | Drawers, sidebars (usar com moderação) |
