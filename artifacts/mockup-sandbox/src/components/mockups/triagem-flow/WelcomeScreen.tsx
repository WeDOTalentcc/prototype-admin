import { Clock, Shield, Mic, CheckSquare } from "lucide-react";
        ...
        <div className="w-full max-w-md bg-white border border-gray-200 rounded-xl shadow-sm p-6 space-y-6">
          ...
          <div className="flex items-start gap-3 p-4 bg-[#00BCD4]/10 rounded-lg">
            ...
            <div className="text-sm text-gray-600 font-['Open_Sans',sans-serif] leading-relaxed">
              ...
              <p>
                Vou conduzir sua triagem para esta vaga. Será uma conversa
                rápida e descontraída sobre sua experiência e habilidades.
              </p>
            </div>
          </div>
          ...
          <label className="flex items-start gap-3 cursor-pointer group">
            ...
            <span className="text-xs text-gray-600 font-['Open_Sans',sans-serif] leading-relaxed select-none">
              Concordo com o tratamento dos meus dados pessoais para fins desta
              triagem, conforme a{" "}
