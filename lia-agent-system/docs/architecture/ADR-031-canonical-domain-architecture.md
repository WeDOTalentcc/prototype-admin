...
### 4.3 Full Tool Catalog

The 31 tools in `platform_tools.yaml` are the subset exposed to **custom agents** via Agent Studio. The full tool inventory across all domain registries is much larger:

- **Total tool definitions: ~248** across 16 domains (as of 2026-06-13)
- **Largest registries:** recruiter_assistant (37), sourcing (37), analytics (27), job_management (24)

**Auto-generated catalog:** `docs/TOOL_CATALOG.md` — generated by `scripts/generate_tool_catalog.py`. Run to refresh:
```bash
python3 scripts/generate_tool_catalog.py
```
Do NOT catalog tools manually in this ADR — the script is authoritative.

### 4.4 Registry Sync Invariant
