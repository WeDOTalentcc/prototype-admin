...
DEFAULT_MATRIX_ENTRIES: List[Dict[str, Any]] = [
    ...
    # Pipeline Transitions (Task #7 — disabled by default, companies enable via Matriz de Comunicação)
    {
        ...
        "trigger_description": "Kanban → Candidato entra no pipeline (intake behavior)",
        "recipient_type": RecipientType.CANDIDATE.value,
        "channels": ["email"],
        "is_automatic": True,
        "template_id": "candidate_intake",
        "requires_approval": False,
        "is_active": False,
        "display_order": 22,
    },
    {
        ...
        "trigger_description": "Kanban → Candidato movido entre colunas (passive behavior)",
        "recipient_type": RecipientType.CANDIDATE.value,
        "channels": ["email"],
        "is_automatic": True,
        "template_id": "candidate_moved",
        "requires_approval": False,
        "is_active": False,
        "display_order": 23,
    },
    {
        ...
        "trigger_description": "Kanban → Avaliação enviada ao candidato (evaluation behavior)",
        "recipient_type": RecipientType.CANDIDATE.value,
        "channels": ["email"],
        "is_automatic": True,
        "template_id": "evaluation_sent",
        "requires_approval": False,
        "is_active": False,
        "display_order": 24,
    },
    {
        ...
        "trigger_description": "Kanban → Verificação solicitada para candidato (verification behavior)",
        "recipient_type": RecipientType.CANDIDATE.value,
        "channels": ["email"],
        "is_automatic": True,
        "template_id": "verification_requested",
        "requires_approval": False,
        "is_active": False,
        "display_order": 25,
    },
    {
        ...
        "trigger_description": "Kanban → Candidato colocado em standby (standby behavior)",
        "recipient_type": RecipientType.RECRUITER.value,
        "channels": ["bell"],
        "is_automatic": True,
        "template_id": None,
