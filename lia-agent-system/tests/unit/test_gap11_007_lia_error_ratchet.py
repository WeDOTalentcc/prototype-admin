...
Ratchet history:
  ...
  2026-06-17: 0   (GAP-11-007 complete: all 91 replaced with LIAInternalError)
"""
import ast
import os

RATCHET_MAX = 0   # COMPLETE: 2026-06-17 all HTTPException(500) replaced with LIAInternalError in app/api/v1/
