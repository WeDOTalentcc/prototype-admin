...
class TestGranularPurposeMap:
    ...
    def test_each_ai_purpose_has_distinct_type(self):
        ...
        from app.domains.lgpd.services.granular_consent_service import GRANULAR_PURPOSE_MAP
    ...
    def test_blocking_purposes_are_ai_related(self):
        ...
        from app.domains.lgpd.services.granular_consent_service import BLOCKING_PURPOSES
...
class TestGranularConsentService:
    ...
    async def test_get_summary_empty_db_returns_all_not_given(self):
        ...
        from app.domains.lgpd.services.granular_consent_service import GranularConsentService, GRANULAR_PURPOSE_MAP
