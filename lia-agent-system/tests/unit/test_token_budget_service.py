...
from app.shared.observability.token_budget_service import get_plan_limit, PLAN_DAILY_LIMITS, DEFAULT_DAILY_LIMIT
...
class TestCheckBudget:
    ...
    async def test_redis_unavailable_allows_call(self):
        ...
        with patch("app.shared.observability.token_budget_service._get_redis", new_callable=AsyncMock) as mock_get:
...
class TestIncrementUsage:
    ...
    async def test_expire_ttl_is_25h(self):
        from app.shared.observability.token_budget_service import _REDIS_TTL
