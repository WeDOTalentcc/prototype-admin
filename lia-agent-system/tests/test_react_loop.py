...
# TestWizardStageDefinitions and TestConfirmationWords were removed in
# Task #850 because `stage_context` and `wizard_react_agent` were
# deleted. The canonical job-creation pipeline (JobCreationGraph) has
# its own stage definitions and routing tests under
# `tests/test_domains/test_job_creation_graph.py`.
