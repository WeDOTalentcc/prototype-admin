# CLAUDE.md — api-onboarding

Micro-app de onboarding de empresas, auth/SSO, integrações, admin e billing.
Porta padrão: `8003`.
...
`scripts/check_auth_provider_adoption.py --subapp onboarding` — detecta novos
endpoints que usam auth legada.

**Baseline 2026-06-13: 55 violations** (todos endpoints legados — PERM-EXEMPT).
