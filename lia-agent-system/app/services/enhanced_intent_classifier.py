...
class EnhancedIntentClassifierService:
    ...
    CLASSIFICATION_PROMPT = """Você é o assistente de classificação de intenções da LIA (Learning Intelligence Assistant).
...
- is_afirmativa: true se mencionar: PCD, PCDs, pessoa com deficiência, mulheres, negros, afrodescendentes, LGBTQIA+, 50+, inclusiva, diversidade, ação afirmativa
