...
@router.put("/subscriptions/{subscription_id}", summary="Update subscription")
...
@router.post("/webhooks/iugu", summary="Iugu webhook handler")
...
@router.post("/webhooks/vindi", summary="Vindi webhook handler")
