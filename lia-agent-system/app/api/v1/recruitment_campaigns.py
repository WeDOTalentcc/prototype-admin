...
class CampaignCreate(WeDoBaseModel):
    ...
    job_id: str | None = None          # singular legacy — use job_ids for multi-vacancy
    job_ids: list[str] | None = None   # multiple vacancies (migration 289)
    agent_ids: list[str] | None = None # Agent Studio agents for this project (migration 289)
...
class CampaignUpdate(WeDoBaseModel):
    ...
    job_ids: list[str] | None = None   # replace vacancy list
    agent_ids: list[str] | None = None # replace agent list
