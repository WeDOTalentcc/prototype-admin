...
async def connect_linkedin(
    ...
    try:
        ...
        try:
            ...
            raise LIAInternalError("Erro ao criptografar credenciais") from exc
        ...
        raise LIAInternalError("Erro ao salvar credenciais") from exc
...
async def disconnect_linkedin(
    ...
    try:
        ...
        raise LIAInternalError("Erro ao desconectar") from exc
