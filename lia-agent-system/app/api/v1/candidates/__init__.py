...
from .candidates_export import router as export_router

router = APIRouter()

for _sub in (crud_router, search_router, metadata_router, consent_router, quick_ask_router, export_router):
