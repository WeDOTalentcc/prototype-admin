...
def _ensure_agents_loaded() -> None:
    ...
    try:
        ...
        from app.domains.autonomous.agents.autonomous_react_agent import AutonomousReActAgent  # noqa: F401  # DEPRECATED-IMPORT-EXEMPT: Tier 6 ReAct fallback canonical — registration trigger pro @register_agent decorator (ADR-V3.1)
