...
_DOMAIN_KEYWORDS: dict[str, list[str]] = {
    "sourcing": [
        ...
        r"apollo",
        r"pearch",
        r"\bcandidatos?\b",  # broad candidate mention — triggers talent tools
        r"me\s+mostr(a|e)",  # "me mostre candidatos / vagas / ..." pattern
    ],
    "job_planner": [
        ...
        r"publicar\s+vagas?",
        r"duplicar\s+vagas?",
        r"\bvagas?\b",  # broad job mention — triggers job-related tools
        r"quantas?\s+vagas?",
        r"listar?\s+vagas?",
    ],
    "job_wizard": [
