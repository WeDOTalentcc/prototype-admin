...
class ConversationState(enum.StrEnum):
    ...
    Flow: INITIAL → WAITING_LGPD → WAITING_CV → CONFIRMING_CV → PRE_QUALIFICATION → 
          ELIGIBILITY_CHECK → (WAITING_RECONSIDERATION | WAITING_CONFIRMATION) → 
          SCREENING → ADDITIONAL_INFO → COMPLETED → FEEDBACK_SENT
