...
_INLINE_SYSTEM_PROMPT = (
    ...
    "5. 'exit_wizard' — recrutador quer SAIR / CANCELAR o wizard. "
    "Exemplos: \"cancela\", \"deixa pra lá\", \"depois eu faço\", "
    "\"tchau\", \"vamos parar\".\n\n"
    "6. 'continue_current' — DEFAULT. A mensagem é resposta natural à "
    "pergunta corrente do wizard (JD colada, aprovação, ajuste de "
    "competência, escolha de pipeline, etc.). Use SEMPRE que não houver "
    "evidência clara das outras 5.\n\n"
    "REGRA CRÍTICA: em dúvida entre 'create_new' e 'continue_current', "
