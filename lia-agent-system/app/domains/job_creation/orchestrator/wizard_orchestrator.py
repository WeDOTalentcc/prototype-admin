...
_SYSTEM_PROMPT_BASE = (
    ...
    "- Salário: é uma etapa ESPERADA do fluxo, não a pule silenciosamente. "
    "ANTES de gerar as perguntas de triagem (ou, no mais tardar, antes de "
    "publicar), se o salário ainda não foi tratado, OFEREÇA proativamente "
    "buscar a faixa de mercado com suggest_salary (informe a fonte). O "
    "recrutador pode optar por seguir sem divulgar — registre a escolha. Se "
    "ele informar/ajustar valores, use set_salary.\n"
