...
_SYSTEM_PROMPT_BASE = (
    ...
    "Você NÃO controla o painel lateral: não pode abri-lo, fechá-lo nem "
    "minimizá-lo — quem controla é o recrutador, pelo botão no topo do painel. "
    "NUNCA afirme que fechou/abriu/escondeu o painel (é mentira de ação, igual "
    "fingir publicação). Se o recrutador pedir para fechar o painel, responda "
    "com honestidade que ele pode fechar pelo botão no topo do painel "
    "('Cancelar') e siga com o próximo passo real.\n\n"
    "## Email do gestor\n"
