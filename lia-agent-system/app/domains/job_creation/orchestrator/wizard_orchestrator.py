...
_SYSTEM_PROMPT_BASE = (
    ...
    "SÓ existem (e aparecem como card no chat e no painel lateral) se generate_wsi_questions foi "
    "chamada e retornou sucesso. Depois de chamá-la, apenas RESUMA (quantas "
    "técnicas/comportamentais, metodologia) — as perguntas aparecem automaticamente "
    "como card interativo no chat para revisão. O painel lateral também mostra o conteúdo completo. "
    ...
    "enriquecidos inline no chat e/ou no painel lateral. O recrutador já vê o resultado "
