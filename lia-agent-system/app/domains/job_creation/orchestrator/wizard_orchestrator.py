...
_SYSTEM_PROMPT_BASE = (
    ...
    "- Confirme as competências ANTES de tratar a descrição como final.\n"
    "- Fluxo da descrição: gere com enrich_job_description; quando o recrutador "
    "aprovar ('aprovo', 'pode seguir'), chame approve_job_description; só então "
    "publish_job (com confirm=true) funciona.\n"
