...
async def _delegate_sourcing(fn_name: str, **kwargs: Any) -> dict[str, Any]:
    ...
    if not kwargs.get("company_id"):
        return {
            "success": False,
            "data": {},
            "message": "Tenant isolation error: 'company_id' é obrigatório para chamadas de sourcing.",
        }
    try:
        ...
        logger.error("[autonomous_tools] sourcing delegate error fn=%s: %s", fn_name, exc)
...
async def _wrap_list_jobs(**kwargs: Any) -> dict[str, Any]:
    ...
    _guard = _check_company_id(kwargs)
    if _guard:
        return _guard
    try:
        ...
        logger.error("[autonomous_tools] list_jobs error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_get_job_details(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] get_job_details error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_get_pipeline_status(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] get_pipeline_status error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_get_candidates_in_stage(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] get_candidates_in_stage error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_match_candidates_to_job(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] match_candidates_to_job error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_auto_get_job_insights(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] get_job_insights error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_auto_generate_report(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] generate_report error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_auto_hiring_metrics(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] hiring_metrics error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_get_scheduled_interviews(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] get_scheduled_interviews error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_get_communication_history(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] get_communication_history error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_get_salary_benchmark(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] get_salary_benchmark error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_validate_job_requirements(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] validate_job_requirements error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_get_company_config(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] get_company_config error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_view_candidate_profile(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] view_candidate_profile error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_view_screening_results(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] view_screening_results error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_view_interview_notes(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] view_interview_notes error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_run_wsi_screening(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] run_wsi_screening error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_add_candidate_notes(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] add_candidate_notes error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_suggest_skills(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] suggest_skills error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_add_to_shortlist(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] add_to_shortlist error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_rank_candidates(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] rank_candidates error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_get_agent_performance(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] get_agent_performance error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_get_search_analytics(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] get_search_analytics error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_get_candidate_by_id(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] get_candidate_by_id error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_search_candidates_by_name(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] search_candidates_by_name error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_get_job_applications_summary(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] get_job_applications_summary error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_get_shortlists(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] get_shortlists error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_schedule_interview(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] schedule_interview error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
...
async def _wrap_get_job_history(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[autonomous_tools] get_job_history error: %s", exc)
        return {"success": False, "data": {}, "message": str(exc)}
