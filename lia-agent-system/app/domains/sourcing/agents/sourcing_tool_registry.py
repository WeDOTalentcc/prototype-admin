...
async def _wrap_set_search_criteria(**kwargs: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(f"[sourcing_tools] set_search_criteria error: {e}", exc_info=True)
...
async def _wrap_suggest_skills(**kwargs: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(f"[sourcing_tools] suggest_skills error: {e}", exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
...
async def _wrap_search_candidates(**kwargs: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(f"[sourcing_tools] search_candidates error: {e}", exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
...
async def _wrap_filter_results(**kwargs: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(f"[sourcing_tools] filter_results error: {e}", exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
...
async def _wrap_analyze_profile(**kwargs: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(f"[sourcing_tools] analyze_profile error: {e}", exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
...
async def _wrap_compare_candidates(**kwargs: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(f"[sourcing_tools] compare_candidates error: {e}", exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
...
async def _wrap_score_candidate(**kwargs: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(f"[sourcing_tools] score_candidate error: {e}", exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
...
async def _wrap_rank_candidates(**kwargs: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(f"[sourcing_tools] rank_candidates error: {e}", exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
...
async def _wrap_generate_message(**kwargs: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(f"[sourcing_tools] generate_message error: {e}", exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
...
async def _wrap_track_response(**kwargs: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(f"[sourcing_tools] track_response error: {e}", exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
...
async def _wrap_view_candidate(**kwargs: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(f"[sourcing_tools] view_candidate error: {e}", exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
...
STAGE_TOOLS: Dict[str, List[str]] = {
    ...
    "shortlist-creation": ["add_to_shortlist", "remove_from_shortlist", "rank_candidates"],
