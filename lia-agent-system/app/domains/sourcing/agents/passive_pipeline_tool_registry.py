...
async def _wrap_passive_search_archived(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[passive_tools] passive_search_archived error: %s", e, exc_info=True)
...
async def _wrap_passive_calculate_fit_score(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[passive_tools] passive_calculate_fit_score error: %s", e, exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
...
async def _wrap_passive_check_lgpd_ttl(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[passive_tools] passive_check_lgpd_ttl error: %s", e, exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
