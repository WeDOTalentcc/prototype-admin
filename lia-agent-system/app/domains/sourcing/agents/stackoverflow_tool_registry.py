...
async def _wrap_so_search_experts(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[so_tools] so_search_experts error: %s", e, exc_info=True)
...
async def _wrap_so_get_user_tags(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[so_tools] so_get_user_tags error: %s", e, exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
...
async def _wrap_so_get_user_answers(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[so_tools] so_get_user_answers error: %s", e, exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
