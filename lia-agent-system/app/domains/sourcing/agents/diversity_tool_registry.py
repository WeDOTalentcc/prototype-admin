...
async def _wrap_diversity_search_candidates(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[diversity_tools] diversity_search_candidates error: %s", e, exc_info=True)
...
async def _wrap_diversity_get_pool_metrics(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[diversity_tools] diversity_get_pool_metrics error: %s", e, exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
...
async def _wrap_diversity_check_goals(**kwargs: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("[diversity_tools] diversity_check_goals error: %s", e, exc_info=True)
        return {"success": False, "data": {}, "message": str(e)}
