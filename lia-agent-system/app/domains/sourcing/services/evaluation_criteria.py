...
from app.domains.sourcing.repositories.evaluation_criteria_repository import (
...
class EvaluationCriteriaService:
    ...
    async def get_criteria_for_requirements(
        ...
        repo = EvaluationCriteriaRepository(db)
        all_criteria = await repo.list_active()
    ...
    async def get_all_active(
        ...
        repo = EvaluationCriteriaRepository(db)
        return await repo.list_active_filtered(category=category)
    ...
    async def get_by_id(
        ...
        repo = EvaluationCriteriaRepository(db)
        return await repo.get_by_id(criteria_id)
