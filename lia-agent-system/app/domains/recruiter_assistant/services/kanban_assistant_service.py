...
class KanbanAssistantService:
    ...
    async def get_suggestions(
        ...
        """Lightweight rules-based suggestions for the recruiter Kanban view.

        Migrated from app.domains.pipeline.kanban_assistant_service (consolidated
        in audit task #324, finding W13). Pure heuristics — no LLM call.
        """
    ...
    async def generate_stage_summary(
        ...
        """Short LLM-generated summary of a Kanban stage. Returns None if LLM unavailable."""
