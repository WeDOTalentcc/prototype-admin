...
# Detecta corrupção de codemod em TS/TSX (escape `\n` literal, import sem aspas)
# que derruba o build do Next.js. Escaneia só os arquivos staged (rápido).
run_sensor "frontend-syntax-corruption" \
    scripts/check_frontend_syntax_corruption.py
