...
PENDING_MIGRATION = {
    ...
    "app/api/v1/compliance_controls.py",
    ...
    "app/api/v1/tasks.py",
    "app/api/v1/teams.py",
    "app/api/v1/technical_tests.py",
    "app/api/v1/test_activities.py",
    "app/api/v1/toon.py",
    "app/api/v1/triagem.py",
    "app/api/v1/trust_center.py",
    ...
    "app/api/v1/workforce.py",
    "app/api/v1/workforce_planning.py",
    "app/api/v1/workos.py",
