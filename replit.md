...
- **Talent Intelligence Domain**: Implements competitive capabilities such as a Skills Ontology Engine, Internal Mobility matching, Workforce Planning, Interview Intelligence (transcript analysis), and Passive Candidate Nurture. These are part of monetizable modules with module-aware tool gating.
