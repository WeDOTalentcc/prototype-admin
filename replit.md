...
- **5-Chat + 2-Channel Architecture**: Comprises dedicated chats for Job Creation, Talent, Jobs Management, Pipeline/Kanban, and Policy, integrated with WhatsApp and MS Teams. Settings pages use the `settings_config` context type via UnifiedChat lateral — no embedded chat.
