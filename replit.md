...
-   **Roadmap MVP Alpha 1 — Cards Unificados v2.0**: Documento `docs/roadmap-mvp-alpha1-cards-unificados.md` enriquecido com 100% do conteúdo dos docs-fonte (6.470 linhas). 62 cards autocontidos com Historia de Usuário, Regras de Negócio, Requisitos Técnicos (FE/BE), DoD, Critérios de Aceitação, Inteligência e Automação (agentes, tools, LLM, governance, fairness, fallbacks), e Arquivos de Referência. Jira: 5 novos épicos (É30=WT-1518, É31=WT-1519, É32=WT-1520, É33=WT-1521, É34=WT-1522) + 35 novos cards (SAT WT-1523→1530, TRI WT-1528→1537, COM WT-1538→1542, INS WT-1543→1546, VOZ WT-1545→1552, PIP WT-1548→1557). Total no Jira: 62 cards + 6 épicos. Última key: WT-1557.
