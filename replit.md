...
-   **Roadmap MVP Alpha 1 — Cards Unificados v4.0**: Documento `docs/roadmap-mvp-alpha1-cards-unificados.md` (5.606 linhas). PIP removidos (v3.0), SendGrid→Mailgun (v4.0). 44 cards autocontidos enriquecidos com: tags padronizadas (backend/frontend/fullstack/dados/IA/comunicacao/voz), referências de código reais do Replit (70+ arquivos mapeados), mapa de agentes IA (11 agentes → cards), modelos de banco PostgreSQL (13 tabelas documentadas), stack de comunicação (Mailgun primário + Meta WhatsApp API + Twilio fallback + Resend fallback), instruções de teste (Como Testar em 11+ cards), e seções de Inteligência e Automação. Jira: 5 épicos (É30=WT-1518, É31=WT-1519, É32=WT-1520, É33=WT-1521, É34=WT-1522) + 27 cards ativos (SAT WT-1523→1530, TRI WT-1528→1537, COM WT-1538→1542, INS WT-1543→1546, VOZ WT-1545→1552). Total: 44 cards · 222 SPs.
