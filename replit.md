...
-   **Roadmap MVP Alpha 1 — Cards Unificados v3.0**: Documento `docs/roadmap-mvp-alpha1-cards-unificados.md` (5.254 linhas). Cards PIP (pipeline-transition) removidos na v3.0 — 44 cards autocontidos restantes com Historia de Usuário, Regras de Negócio, Requisitos Técnicos (FE/BE), DoD, Critérios de Aceitação, Inteligência e Automação, e Arquivos de Referência. Jira: 5 épicos (É30=WT-1518, É31=WT-1519, É32=WT-1520, É33=WT-1521, É34=WT-1522) + 27 cards ativos (SAT WT-1523→1530, TRI WT-1528→1537, COM WT-1538→1542, INS WT-1543→1546, VOZ WT-1545→1552). Total ativo: 44 cards · 222 SPs.
