...
-   **Roadmap MVP Alpha 1 — Cards Unificados v5.2**: Documento `docs/roadmap-mvp-alpha1-cards-unificados.md` (7.854 linhas). v5.0: 15 seções globais de referência IA. v5.1: §11 — É35 Arquitetura de IA (AGT) com 21 cards. v5.2: Enriquecimento completo dos 21 cards AGT com dados do `diagnostico-agentes-mvp.md` (5.251 linhas) — cada card contém: Estado V5 vs LIA, Gap Analysis, Tools com Serviços (tabela), API Endpoints, Padrão 13B.7, Camadas Suporte Obrigatórias, Roteiro de Reprodução (§13C.17), Automações, Para Alpha 1. 21 cards Jira (WT-1559→WT-1579) sincronizados com descrições enriquecidas. Épico WT-1558. Total: 65 cards · 413 SPs (44 funcionalidade + 21 arquitetura IA, 8 épicos).
-   **Deep Audit Playbook**: Self-contained, reusable playbook for executing deep audits across code, AI prompts, agents, architecture, compliance, governance, DEI and data protection. Consolidates 8 analysis frameworks (feature-audit, feature-impact, wedo-governance, code_review, screening-compliance, dei-fairness, lgpd-data-protection) into a single document with 9 parts, 14 audit dimensions, and structured report format. File: `docs/PLAYBOOK_AUDITORIA_PROFUNDA.md`.
