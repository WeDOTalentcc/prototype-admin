...
from app.prompts.templates import PromptTemplate, PromptLibrary
from app.prompts.examples import FewShotExamples
from app.prompts.cot import ChainOfThoughtBuilder
...
Estado atual do rascunho: {job_draft_summary}

Ações disponíveis:
- **respond**: Apenas responder com informação, sem alterar dados
- **update_fields**: Atualizar campos específicos da vaga
- **advance_stage**: Avançar para o próximo estágio
- **request_clarification**: Pedir esclarecimento quando informações são ambíguas

Sempre seja prestativa, profissional e eficiente.""",
