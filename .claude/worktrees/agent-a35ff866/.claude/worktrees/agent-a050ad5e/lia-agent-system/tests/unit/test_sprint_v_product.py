...
class TestRecruiterProfileService:
    ...
    def test_profile_consultive_tone_snippet(self):
        from app.services.recruiter_profile_service import RecruiterProfile, TonePreference
        profile = RecruiterProfile(
            user_id="u1", company_id="c1",
...
class TestWSIAsyncSessionService:
    def test_module_importable(self):
        from app.services.wsi_async_session_service import WSIAsyncSessionService, WSIAsyncSessionStatus
    ...
    def test_session_timeout_configured(self):
        from app.services.wsi_async_session_service import WSI_SESSION_TIMEOUT_HOURS
    ...
    def test_session_ttl_constant(self):
        from app.services.wsi_async_session_service import WSI_SESSION_TTL_SECONDS, WSI_SESSION_TIMEOUT_HOURS
    ...
    def test_singleton_instance_exists(self):
        from app.services.wsi_async_session_service import wsi_async_session_service, WSIAsyncSessionService
