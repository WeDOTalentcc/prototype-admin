...
from app.tools.job_wizard_tools import generate_enriched_jd
...
class SmartOrchestrateRequest(BaseModel):
    ...
    company_id: Optional[str] = Field(None, description="Company ID override")
    user_id: Optional[str] = Field(None, description="User ID override")
...
class SmartOrchestrateResponse(BaseModel):
    ...
    job_vacancy_id: Optional[str] = Field(
        None,
