      ...
      <div className="flex items-center justify-between">
        <div className="flex gap-2">
          ...
          <Button
            ...
            className={templateChannelFilter === 'whatsapp' ? 'bg-green-600 hover:bg-green-700' : ''}
          >
          ...
          <Button
            ...
            className={templateChannelFilter === 'bell' ? 'bg-amber-600 hover:bg-amber-700 text-white' : ''}
          >
          ...
          <Button
            ...
            className={templateChannelFilter === 'briefing' ? 'bg-yellow-600 hover:bg-yellow-700 text-white' : ''}
          >
          ...
          <Button
            ...
            className={templateChannelFilter === 'parecer' ? 'bg-purple-600 hover:bg-purple-700 text-white' : ''}
          >
