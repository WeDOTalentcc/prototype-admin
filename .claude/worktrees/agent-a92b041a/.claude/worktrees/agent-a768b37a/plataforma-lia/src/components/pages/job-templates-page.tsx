            ...
            <Card key={template.id} className="hover:transition-shadow">
              ...
              <CardContent className="pt-0">
                ...
                <div className="space-y-2">
                  ...
                  <Button size="sm" variant="default" className="w-full gap-2 bg-gray-900 hover:bg-gray-800 text-white dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-200">
