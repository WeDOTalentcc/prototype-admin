...
export function SalaryStage() {
  ...
  return (
    <div className="space-y-3">
        ...
        <div className="p-3 bg-gradient-to-r from-gray-50 dark:from-gray-900 to-[#22C55E]/5 rounded-md border border-gray-300 dark:border-gray-600">
          <div className="flex items-center gap-2 mb-2">
            ...
            {salaryBenchmark.market?.learning_adjusted && (
              <span className="px-1.5 py-0.5 bg-[#22C55E]/10 text-[#166534] text-[9px] font-medium rounded-full">
                Personalizado
              </span>
            )}
          </div>
            ...
            <div className="mb-2 p-2 bg-white/50 rounded-md">
              <div className="flex items-center justify-between mb-1">
                ...
                {salaryBenchmark.internal.trend && salaryBenchmark.internal.trend !== 'stable' && (
                  <span className={`text-[9px] ${salaryBenchmark.internal.trend === 'increasing' ? 'text-[#22C55E]' : 'text-[#EF4444]'}`}>
            ...
            <div className="mb-2 p-2 bg-white/50 rounded-md">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className={`text-[9px] px-1.5 py-0.5 rounded-full ${
                  salaryBenchmark.market.confidence === 'high' ? 'bg-[#22C55E]/10 text-[#166534]' :
                  salaryBenchmark.market.confidence === 'medium' ? 'bg-[#F59E0B]/10 text-[#92400E]' :
          ...
          {salaryBenchmark.combined && (
            <button
              ...
              className="w-full py-1.5 mt-1 bg-gray-900 hover:bg-gray-800 text-white dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-200 text-[10px] font-medium rounded-md transition-colors flex items-center justify-center gap-1"
            >
      ...
      {/* Loading Benchmark */}
      {isLoadingBenchmark && (
        <div className="p-3 bg-[#F8FAFB] rounded-md border border-gray-200 flex items-center gap-2">
      ...
      <div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {valueDisplay && (
                            <span className="text-[9px] text-gray-400">{valueDisplay}</span>
                          )}
                          {benefit.provider && (
                            <span className="text-[8px] text-[#BBBBBB] block truncate">{benefit.provider}</span>
                          )}
                        </div>
                      </button>
                    )
        ...
        {/* Add Benefit Modal */}
        {showAddBenefitModal && (
          <div className="mt-2 p-3 bg-[#F8FAFB] rounded-md border border-gray-200 space-y-2">
            <input
              type="text"
      ...
      {/* Summary */}
      <div className="p-2 bg-[#F0F9FA] rounded-md border border-gray-300 dark:border-gray-600">
