...
**Data/Hora:** 2026-04-03T18:44:45.077824
**Base URL:** http://localhost:5000
**Candidatos avaliados:** 80
**Candidatos com erro:** 79
...
|----------|---------|--------|---------|--------|-------|-----------|--------|
| Gênero | Masculino | 0.0% (0/0) | Feminino | 0.0% (0/1) | 1.000 | ≥ 0.800 | ✅ APROVADO |
| Faixa Etária | Jovem (25-30) | 0.0% (0/0) | Experiente (45-55) | 0.0% (0/0) | 1.000 | ≥ 0.800 | ✅ APROVADO |
| Etnia (Nome Codificado) | Nome Europeu | 0.0% (0/1) | Nome Afro-Brasileiro | 0.0% (0/0) | 1.000 | ≥ 0.800 | ✅ APROVADO |

### Médias de Pontuação e Tamanho de Efeito (Cohen's d)

| Dimensão | Média Grupo A | Média Grupo B | Cohen's d | Interpretação |
|----------|--------------|--------------|-----------|---------------|
| Gênero | 0.0 | 3.8 | 0.000 | Trivial |
| Faixa Etária | 0.0 | 0.0 | 0.000 | Trivial |
| Etnia (Nome Codificado) | 3.8 | 0.0 | 0.000 | Trivial |
...
|---|-----|-------|------------|---------|------------|---------|-----------|----------|
| 1 | pair_13 | gender | Eduardo Barros Lima | 0.0 | Eduarda Barros Lima | 3.8 | -3.80 | ⚠️ SIM |
| 2 | pair_01 | gender | Carlos Eduardo Silva | 0.0 | Carla Eduardo Silva | 0.0 | +0.00 | Não |
| 3 | pair_02 | gender | Ricardo Mendes Costa | 0.0 | Roberta Mendes Costa | 0.0 | +0.00 | Não |
| 4 | pair_03 | gender | Fernando Alves Ramos | 0.0 | Fernanda Alves Ramos | 0.0 | +0.00 | Não |
| 5 | pair_04 | gender | Lucas Pereira Gomes | 0.0 | Letícia Pereira Gomes | 0.0 | +0.00 | Não |
