...
| F6 — Geração perguntas comportamentais | LLM | Claude 3.5 Sonnet / Gemini 1.5 Pro | 0.75 | Validação automática pós-geração |
...
def calcular_score_final_trait(trait: str, jd: JobDescription) -> float:
    score_llm    = abordagem_c[trait]["score"]        # Abordagem C
    score_prior  = abordagem_b[trait]                 # Abordagem B
    score_lexico = abordagem_a[trait]                 # Abordagem A (boost)
...
## APÊNDICE B — Conformidade: EU AI Act, LGPD, DEI

### B.1 EU AI Act — High-Risk AI
...
### B.2 LGPD — Proteção de dados do candidato
...
### B.3 DEI — Diversidade, Equidade e Inclusão
...
## APÊNDICE C — Trace Completo Ponta-a-Ponta
