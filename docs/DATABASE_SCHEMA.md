# Database Schema — Plataforma LIA (PostgreSQL)

> Gerado automaticamente a partir dos modelos SQLAlchemy.
> **Total de tabelas: 301**
...
- **agent_activity** — `agent_activities`, `agent_metrics_snapshots`
...
- **candidate** — `candidate_education`, `candidate_experiences`, `candidate_favorites`, `candidate_hidden`, `candidate_merge_audit`, `candidate_searches`, `candidate_sources`, `candidates`, `credits_usage`, `external_candidate_profiles`, `vacancy_candidates`, `viewed_candidates`
...
- **company_learning** — `agent_feedback`, `company_patterns`, `company_responsibilities`, `company_skills`, `feature_flags`, `learning_analytics`, `stage_feedback`
...
- **global_policies** — `platform_global_policies`, `platform_policy_audit_logs`
...
- **integration_hub** — `integration_connections`, `integration_providers`, `integration_sync_logs`, `integration_webhooks`
- **intelligence_layer** — `correction_patterns`, `intelligence_insights`, `outcome_correlations`, `pattern_cache`, `success_profiles`
- **intelligent_cache** — `cache_entries`, `feedback_events`, `query_embeddings`, `token_usage_logs`
...
- **job_template** — `job_templates`, `template_categories`, `template_usage_logs`
- **job_vacancy** — `job_vacancies`, `job_vacancy_interview_stages`, `job_vacancy_templates`
...
- **observability** — `ai_inference_logs`, `automated_decision_explanations`, `bias_audit_reports`, `breach_notifications`, `business_processes`, `company_compliance_controls`, `compliance_audits`, `compliance_control_library`, `compliance_controls`, `consent_events`, `consent_records`, `consent_versions`, `continuity_tests`, `data_access_logs`, `data_subject_requests`, `disaster_recovery_plans`, `dpo_registry`, `incident_reports`, `insurance_claims`, `insurance_coverages`, `insurance_documents`, `insurance_policies`, `model_evaluations`, `risk_entries`, `risk_treatments`, `sod_conflicts`, `sod_roles`, `sod_violations`, `sox_controls`
...
- **recruiter_decision_feedback** — `recruiter_decision_feedback`
...
- **task_record** — `dead_letter_queue`, `task_records`, `task_schedules`
- **teams** — `teams_action_audit_logs`, `teams_conversations`, `teams_messages`, `teams_notifications`
...
### `ab_test_results`
**Classe:** `ABTestResult` | **Herda:** `Base`
...
### `prompt_variants`
**Classe:** `PromptVariant` | **Herda:** `Base`
...
### `activity_feed`
**Classe:** `ActivityFeed` | **Herda:** `Base`
...
### `admin_audit_logs`
**Classe:** `AdminAuditLog` | **Herda:** `Base`
...
### `admin_user_roles`
**Classe:** `AdminUserRole` | **Herda:** `Base`
...
**Classe:** `NotificationPolicy` | **Herda:** `Base`
...
### `security_settings`
**Classe:** `SecuritySetting` | **Herda:** `Base`
...
**Classe:** `AffirmativeAuditLog` | **Herda:** `Base`
...
**Classe:** `CandidateAffirmativeDocument` | **Herda:** `Base`
...
## agent_activity
**Arquivo:** `lia-agent-system/libs/models/lia_models/agent_activity.py`

### `agent_activities`
**Classe:** `AgentActivity` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | String(255) | PK, default=lambda: str(uuid.uuid4( |
| `agent_id` | String(50) | NOT NULL, INDEX |
| `agent_name` | String(100) | NOT NULL |
| `agent_icon` | String(10) | default="🤖" |
| `activity_type` | String(50) | NOT NULL, INDEX |
| `title` | String(255) | NOT NULL |
| `description` | Text | — |
| `status` | Enum(ActivityStatus) | INDEX, default=ActivityStatus.PENDING |
| `started_at` | DateTime | INDEX, default=datetime.utcnow |
| `completed_at` | DateTime | — |
| `duration_seconds` | Float | — |
| `sla_breach` | Boolean | default=False |
| `sla_deadline` | DateTime | — |
| `related_job_id` | String(255) | INDEX |
| `related_candidate_id` | String(255) | INDEX |
| `activity_metadata` | JSON | default=dict |
| `result_data` | JSON | — |
| `error_message` | Text | — |
| `created_at` | DateTime | default=datetime.utcnow |

### `agent_metrics_snapshots`
**Classe:** `AgentMetricsSnapshot` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | String(255) | PK, default=lambda: str(uuid.uuid4( |
| `agent_id` | String(50) | NOT NULL, INDEX |
| `snapshot_hour` | DateTime | NOT NULL, INDEX |
...
**Classe:** `AgentApprovalRequest` | **Herda:** `Base`
...
### `agent_checkpoints`
**Classe:** `AgentCheckpoint` | **Herda:** `Base`
...
### `agent_deployments`
**Classe:** `AgentDeployment` | **Herda:** `Base`
...
**Classe:** `AgentExecutionLog` | **Herda:** `Base`
...
**Classe:** `AgentQualityEvaluation` | **Herda:** `Base`
...
### `agent_templates`
**Classe:** `AgentTemplate` | **Herda:** `Base`
...
**Classe:** `AgentVersionSnapshot` | **Herda:** `Base`
...
### `ai_consumption`
**Classe:** `AiConsumption` | **Herda:** `Base`
...
### `ai_credits_balance`
**Classe:** `AiCreditsBalance` | **Herda:** `Base`
...
### `alert_preferences`
**Classe:** `AlertPreference` | **Herda:** `Base`
...
### `approval_requests`
**Classe:** `ApprovalRequest` | **Herda:** `Base`
...
### `search_archetypes`
**Classe:** `SearchArchetype` | **Herda:** `Base`
...
### `ats_candidates`
**Classe:** `ATSCandidate` | **Herda:** `Base`
...
### `ats_connections`
**Classe:** `ATSConnection` | **Herda:** `Base`
...
### `ats_job_mappings`
**Classe:** `ATSJobMapping` | **Herda:** `Base`
...
### `ats_webhook_logs`
**Classe:** `ATSWebhookLog` | **Herda:** `Base`
...
**Classe:** `AuditRetentionPolicy` | **Herda:** `Base`
...
### `ai_suggestions`
**Classe:** `AISuggestion` | **Herda:** `Base`
...
**Classe:** `AutomationExecutionLog` | **Herda:** `Base`
...
**Classe:** `CommunicationAutomation` | **Herda:** `Base`
...
**Classe:** `StageAutomationRule` | **Herda:** `Base`
...
### `background_jobs`
**Classe:** `BackgroundJob` | **Herda:** `Base`
...
### `proactive_actions`
**Classe:** `ProactiveAction` | **Herda:** `Base`
...
**Classe:** `BiasAuditSnapshot` | **Herda:** `Base`
...
### `company_modules`
**Classe:** `CompanyModule` | **Herda:** `Base`
...
### `credit_accounts`
**Classe:** `CreditAccount` | **Herda:** `Base`
...
### `credit_transactions`
**Classe:** `CreditTransaction` | **Herda:** `Base`
...
### `payment_methods`
**Classe:** `PaymentMethod` | **Herda:** `Base`
...
### `subscriptions`
**Classe:** `Subscription` | **Herda:** `Base`
...
### `calibration_events`
**Classe:** `CalibrationEvent` | **Herda:** `Base`
...
**Classe:** `CalibrationFeedback` | **Herda:** `Base`
...
**Classe:** `CalibrationSession` | **Herda:** `Base`
...
**Classe:** `CalibrationSuggestion` | **Herda:** `Base`
...
### `calibration_weights`
**Classe:** `CalibrationWeight` | **Herda:** `Base`
...
### `candidate_education`
**Classe:** `CandidateEducation` | **Herda:** `Base`
...
**Classe:** `CandidateExperience` | **Herda:** `Base`
...
### `candidate_favorites`
**Classe:** `CandidateFavorite` | **Herda:** `Base`
...
### `candidate_hidden`
**Classe:** `CandidateHidden` | **Herda:** `Base`
...
**Classe:** `CandidateMergeAudit` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `canonical_candidate_id` | UUID | INDEX, FK → candidates.id |
| `merged_profile_id` | UUID | INDEX |
| `merged_profile_source` | String(50) | — |
| `merged_profile_source_id` | String(255) | — |
| `decision` | String(50) | NOT NULL |
| `decision_source` | String(50) | NOT NULL |
...
### `candidate_searches`
**Classe:** `CandidateSearch` | **Herda:** `Base`
...
### `candidate_sources`
**Classe:** `CandidateSource` | **Herda:** `Base`
...
### `candidates`
**Classe:** `Candidate` | **Herda:** `EncryptedFieldMixin, Base`
...
### `credits_usage`
**Classe:** `CreditsUsage` | **Herda:** `Base`
...
**Classe:** `ExternalCandidateProfile` | **Herda:** `Base`
...
### `vacancy_candidates`
**Classe:** `VacancyCandidate` | **Herda:** `Base`
...
### `viewed_candidates`
**Classe:** `ViewedCandidate` | **Herda:** `Base`
...
**Classe:** `CandidateAttachment` | **Herda:** `Base`
...
### `candidate_feedbacks`
**Classe:** `CandidateFeedback` | **Herda:** `Base`
...
### `candidate_jobs`
**Classe:** `CandidateJob` | **Herda:** `Base`
...
**Classe:** `CandidateListMember` | **Herda:** `Base`
...
### `candidate_lists`
**Classe:** `CandidateList` | **Herda:** `Base`
...
### `client_accounts`
**Classe:** `ClientAccount` | **Herda:** `Base`
...
### `client_users`
**Classe:** `ClientUser` | **Herda:** `EncryptedFieldMixin, Base`
...
### `communication_history`
**Classe:** `CommunicationHistory` | **Herda:** `Base`
...
**Classe:** `CommunicationMatrixEntry` | **Herda:** `Base`
...
### `communication_settings`
**Classe:** `CommunicationSettings` | **Herda:** `Base`
...
### `benefit_templates`
**Classe:** `BenefitTemplate` | **Herda:** `Base`
...
### `big_five_questions`
**Classe:** `BigFiveQuestion` | **Herda:** `Base`
...
**Classe:** `BigFiveRoleProfile` | **Herda:** `Base`
...
### `company_profiles`
**Classe:** `CompanyProfile` | **Herda:** `Base`
...
### `culture_values`
**Classe:** `CultureValue` | **Herda:** `Base`
...
### `department_members`
**Classe:** `DepartmentMember` | **Herda:** `Base`
...
**Classe:** `GlobalSearchSettings` | **Herda:** `Base`
...
### `ideal_profiles`
**Classe:** `IdealProfile` | **Herda:** `Base`
...
### `technical_questions`
**Classe:** `TechnicalQuestion` | **Herda:** `Base`
...
**Classe:** `TechnicalTestTemplate` | **Herda:** `Base`
...
### `company_benefits`
**Classe:** `CompanyBenefit` | **Herda:** `Base`
...
### `company_calendar_credentials`
**Classe:** `CompanyCalendarCredentials` | **Herda:** `Base`
...
**Classe:** `CompanyCultureProfile` | **Herda:** `Base`
...
**Classe:** `CultureAnalysisJob` | **Herda:** `Base`
...
**Classe:** `CompanyHiringPolicy` | **Herda:** `Base`
...
### `agent_feedback`
**Classe:** `AgentFeedback` | **Herda:** `Base`
...
### `company_patterns`
**Classe:** `CompanyPattern` | **Herda:** `Base`
...
**Classe:** `CompanyResponsibility` | **Herda:** `Base`
...
### `company_skills`
**Classe:** `CompanySkill` | **Herda:** `Base`
...
### `learning_analytics`
**Classe:** `LearningAnalytics` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `company_id` | String(255) | NOT NULL, INDEX |
| `metric_type` | String(100) | NOT NULL, INDEX |
| `metric_key` | String(255) | NOT NULL |
...
### `stage_feedback`
**Classe:** `StageFeedback` | **Herda:** `Base`
...
**Classe:** `CompensationPolicy` | **Herda:** `Base`
...
**Classe:** `ConversationSummary` | **Herda:** `Base`
...
### `conversations`
**Classe:** `Conversation` | **Herda:** `Base`
...
### `agent_installations`
**Classe:** `AgentInstallation` | **Herda:** `Base`
...
**Classe:** `AgentMarketplaceListing` | **Herda:** `Base`
...
**Classe:** `DataRequestConfig` | **Herda:** `Base`
...
### `data_request_fields`
**Classe:** `DataRequestField` | **Herda:** `Base`
...
**Classe:** `DataRequestResponse` | **Herda:** `Base`
...
**Classe:** `DataRequestTemplate` | **Herda:** `Base`
...
**Classe:** `VacancyDataRequestConfig` | **Herda:** `Base`
...
### `default_templates`
**Classe:** `DefaultTemplate` | **Herda:** `Base`
...
### `twin_decisions`
**Classe:** `TwinDecision` | **Herda:** `Base`
...
### `email_templates`
**Classe:** `EmailTemplate` | **Herda:** `Base`
...
**Classe:** `EmailTrackingEvent` | **Herda:** `Base`
...
### `evaluation_criteria`
**Classe:** `EvaluationCriteria` | **Herda:** `Base`
...
**Classe:** `AgentExecutionRecord` | **Herda:** `Base`
...
### `external_api_consumption`
**Classe:** `ExternalApiConsumption` | **Herda:** `Base`
...
### `fairness_audit_log`
**Classe:** `FairnessAuditLog` | **Herda:** `Base`
...
**Classe:** `InteractionFeedback` | **Herda:** `Base`
...
### `learning_patterns`
**Classe:** `LearningPattern` | **Herda:** `Base`
...
### `suggestion_feedback`
**Classe:** `SuggestionFeedback` | **Herda:** `Base`
...
### `wizard_feedback`
**Classe:** `WizardFeedback` | **Herda:** `Base`
...
**Classe:** `PlatformPolicy` | **Herda:** `Base`
...
### `platform_policy_audit_logs`
**Classe:** `PlatformPolicyAuditLog` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `policy_id` | UUID | NOT NULL, INDEX, FK → platform_global_policies.id |
| `previous_value` | String(500) | — |
| `new_value` | String(500) | NOT NULL |
| `changed_by` | UUID | — |
| `changed_at` | DateTime | INDEX, default=func.now(, server_default |
| `change_reason` | Text | — |
| `Tracks` | UUID | PK, default=uuid.uuid4 |
...
### `global_policies`
**Classe:** `GlobalPolicy` | **Herda:** `Base`
...
### `goal_templates`
**Classe:** `GoalTemplate` | **Herda:** `Base`
...
### `graph_sessions`
**Classe:** `GraphSession` | **Herda:** `Base`
...
**Classe:** `ComplianceHealthCheckHistory` | **Herda:** `Base`
...
**Classe:** `ComplianceHealthCheckItem` | **Herda:** `Base`
...
### `hitl_audit_trail`
**Classe:** `HITLAuditTrail` | **Herda:** `Base`
...
**Classe:** `HITLPendingAction` | **Herda:** `Base`
...
**Classe:** `ClientSkillCatalog` | **Herda:** `Base`
...
**Classe:** `ImportedJobDescription` | **Herda:** `Base`
...
**Classe:** `IntegrationConnection` | **Herda:** `Base`
...
**Classe:** `IntegrationProvider` | **Herda:** `Base`
...
**Classe:** `IntegrationSyncLog` | **Herda:** `Base`
...
**Classe:** `IntegrationWebhook` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `connection_id` | UUID | NOT NULL, FK → integration_connections.id |
| `webhook_url` | String(500) | NOT NULL |
...
### `correction_patterns`
**Classe:** `CorrectionPattern` | **Herda:** `Base`
...
**Classe:** `IntelligenceInsight` | **Herda:** `Base`
...
**Classe:** `OutcomeCorrelation` | **Herda:** `Base`
...
### `pattern_cache`
**Classe:** `PatternCache` | **Herda:** `Base`
...
### `success_profiles`
**Classe:** `SuccessProfile` | **Herda:** `Base`
...
### `feedback_events`
**Classe:** `FeedbackEvent` | **Herda:** `Base`
...
| `suggested_value` | JSON | — |
| `final_value` | JSON | — |
| `outcome` | String(20) | NOT NULL, INDEX |
| `modification_delta` | JSON | — |
| `role` | String(255) | INDEX |
| `seniority` | String(100) | — |
| `department` | String(100) | — |
| `location` | String(255) | — |
| `source` | String(100) | — |
| `source_confidence` | Float | — |
| `response_time_ms` | Integer | — |
| `processed_for_learning` | Boolean | INDEX, default=False |
| `created_at` | DateTime | INDEX, default=datetime.utcnow |
| `created_by` | String(255) | — |

### `query_embeddings`
**Classe:** `QueryEmbedding` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `query_text` | Text | NOT NULL |
| `query_hash` | String(64) | NOT NULL, INDEX |
| `namespace` | String(100) | NOT NULL, INDEX |
| `company_id` | String(255) | INDEX |
| `embedding` | Float | NOT NULL |
| `embedding_model` | String(100) | default="text-embedding-3-small" |
| `embedding_dimensions` | Integer | default=1536 |
| `cache_key` | String(512) | INDEX |
| `hit_count` | Integer | default=0 |
| `expires_at` | DateTime | — |
| `created_at` | DateTime | default=datetime.utcnow |

### `token_usage_logs`
**Classe:** `TokenUsageLog` | **Herda:** `Base`
...
| `company_id` | String(255) | NOT NULL, INDEX |
| `session_id` | String(255) | — |
| `operation` | String(100) | NOT NULL, INDEX |
...
**Classe:** `CalendarAvailability` | **Herda:** `Base`
...
### `interview_feedbacks`
**Classe:** `InterviewFeedback` | **Herda:** `Base`
...
### `interview_notes`
**Classe:** `InterviewNote` | **Herda:** `Base`
...
### `draft_field_history`
**Classe:** `DraftFieldHistory` | **Herda:** `Base`
...
### `job_embeddings`
**Classe:** `JobEmbedding` | **Herda:** `Base`
...
### `salary_benchmarks`
**Classe:** `SalaryBenchmark` | **Herda:** `Base`
...
### `skill_clusters`
**Classe:** `SkillCluster` | **Herda:** `Base`
...
### `template_categories`
**Classe:** `TemplateCategory` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid4 |
| `name` | String(50) | NOT NULL, UNIQUE, INDEX |
| `display_name` | String(100) | NOT NULL |
| `description` | Text | — |
| `icon` | String(50) | — |
| `color` | String(20) | — |
| `parent_id` | UUID | FK → template_categories.id |
...
### `template_usage_logs`
**Classe:** `TemplateUsageLog` | **Herda:** `Base`
...
**Classe:** `JobVacancyInterviewStage` | **Herda:** `Base`
...
| `script_url` | String(500) | — |
| `is_active` | Boolean | default=True |
| `created_at` | DateTime | default=datetime.utcnow |
| `updated_at` | DateTime | default=datetime.utcnow |
| `stage_name` | String(100) | NOT NULL, default=1 |

### `job_vacancy_templates`
**Classe:** `JobVacancyTemplate` | **Herda:** `Base`
...
| `name` | String(255) | NOT NULL |
| `description` | Text | — |
| `default_interview_stages` | JSON | default=list |
| `default_screening_questions` | JSON | default=list |
| `default_timeline_weeks` | Integer | default=4 |
| `default_governance_rules` | JSON | default={} |
| `is_active` | Boolean | default=True |
| `usage_count` | Integer | default=0 |
| `created_at` | DateTime | default=datetime.utcnow |
| `updated_at` | DateTime | default=datetime.utcnow |
| `category` | String(100) | default=list |
| `is_public` | String(255) | default=False |
...
**Classe:** `JobVacancyAuditLog` | **Herda:** `Base`
...
### `journey_blueprints`
**Classe:** `JourneyBlueprint` | **Herda:** `Base`
...
**Classe:** `JourneyIntegration` | **Herda:** `Base`
...
### `lia_field_toggles`
**Classe:** `LiaFieldToggle` | **Herda:** `Base`
...
**Classe:** `LiaProfileAnalysis` | **Herda:** `Base`
...
**Classe:** `AgentLongTermMemory` | **Herda:** `Base`
...
| `memory_key` | String(255) | NOT NULL |
| `memory_value` | JSON | default=dict |
| `context_tags` | JSON | default=list |
| `usage_count` | Integer | default=0 |
| `relevance_score` | Float | default=1.0 |
| `source_session_id` | String(255) | NOT NULL |
...
**Classe:** `ConversationMemory` | **Herda:** `Base`
...
### `knowledge_base`
**Classe:** `KnowledgeBase` | **Herda:** `Base`
...
### `message_queue`
**Classe:** `MessageQueue` | **Herda:** `Base`
...
### `ml_model_registry`
**Classe:** `MLModelRegistryRecord` | **Herda:** `Base`
...
### `chat_notifications`
**Classe:** `ChatNotification` | **Herda:** `Base`
...
### `notifications`
**Classe:** `Notification` | **Herda:** `Base`
...
### `ai_inference_logs`
**Classe:** `AIInferenceLog` | **Herda:** `Base`
...
**Classe:** `AutomatedDecisionExplanation` | **Herda:** `Base`
...
### `bias_audit_reports`
**Classe:** `BiasAuditReport` | **Herda:** `Base`
...
**Classe:** `BreachNotification` | **Herda:** `Base`
...
### `business_processes`
**Classe:** `BusinessProcess` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `company_id` | UUID | NOT NULL, INDEX |
| `process_code` | String(50) | NOT NULL, INDEX |
| `process_name` | String(500) | NOT NULL |
| `department` | String(255) | — |
| `criticality` | String(20) | NOT NULL, INDEX, default="tier_4_standard" |
| `rto_hours` | Integer | — |
| `rpo_hours` | Integer | — |
| `mtpd_hours` | Integer | — |
| `dependencies` | UUID | default=list |
| `responsible_team` | String(255) | — |
...
**Classe:** `CompanyComplianceControl` | **Herda:** `Base`
...
### `compliance_audits`
**Classe:** `ComplianceAudit` | **Herda:** `Base`
...
**Classe:** `ComplianceControlLibrary` | **Herda:** `Base`
...
### `compliance_controls`
**Classe:** `ComplianceControl` | **Herda:** `Base`
...
### `consent_events`
**Classe:** `ConsentEvent` | **Herda:** `Base`
...
### `consent_records`
**Classe:** `ConsentRecord` | **Herda:** `Base`
...
### `consent_versions`
**Classe:** `ConsentVersion` | **Herda:** `Base`
...
### `continuity_tests`
**Classe:** `ContinuityTest` | **Herda:** `Base`
...
| `company_id` | UUID | NOT NULL, INDEX |
| `plan_id` | UUID | INDEX |
| `test_type` | String(20) | NOT NULL, INDEX |
| `test_name` | String(500) | NOT NULL |
| `scheduled_date` | Date | NOT NULL |
| `executed_date` | Date | — |
| `status` | String(20) | NOT NULL, INDEX, default="scheduled" |
| `participants` | String | default=list |
| `findings` | Text | — |
| `improvements_identified` | JSON | default=list |
| `next_steps` | Text | — |
| `created_at` | DateTime | INDEX, default=func.now(, server_default |

### `data_access_logs`
**Classe:** `DataAccessLog` | **Herda:** `Base`
...
**Classe:** `DataSubjectRequest` | **Herda:** `Base`
...
**Classe:** `DisasterRecoveryPlan` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `company_id` | UUID | NOT NULL, INDEX |
| `plan_name` | String(500) | NOT NULL |
| `version` | String(20) | NOT NULL |
| `status` | String(20) | NOT NULL, INDEX, default="draft" |
| `scope` | Text | — |
| `recovery_steps` | JSON | default=list |
| `contact_list` | JSON | default=list |
| `approved_by` | UUID | — |
| `approved_at` | DateTime | — |
| `last_tested_at` | DateTime | — |
| `test_results` | Text | — |
...
### `incident_reports`
**Classe:** `IncidentReport` | **Herda:** `Base`
...
### `insurance_claims`
**Classe:** `InsuranceClaim` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `policy_id` | UUID | NOT NULL, INDEX |
| `claim_number` | String(100) | NOT NULL, INDEX |
| `incident_date` | Date | NOT NULL, INDEX |
| `reported_date` | Date | NOT NULL |
| `description` | Text | NOT NULL |
| `estimated_loss` | Numeric(18, 2) | NOT NULL |
| `claimed_amount` | Numeric(18, 2) | NOT NULL |
| `settled_amount` | Numeric(18, 2) | — |
| `status` | String(20) | NOT NULL, INDEX, default="reported" |
| `related_incident_id` | UUID | INDEX |
| `created_at` | DateTime | INDEX, default=func.now(, server_default |
| `updated_at` | DateTime | default=func.now(, server_default |

### `insurance_coverages`
**Classe:** `InsuranceCoverage` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `policy_id` | UUID | NOT NULL, INDEX |
| `coverage_type` | String(50) | NOT NULL, INDEX |
| `description` | Text | — |
| `coverage_limit` | Numeric(18, 2) | NOT NULL |
| `sub_limit` | Numeric(18, 2) | — |
...
### `insurance_documents`
**Classe:** `InsuranceDocument` | **Herda:** `Base`
...
| `uploaded_by` | UUID | — |
| `uploaded_at` | DateTime | INDEX, default=func.now(, server_default |

### `insurance_policies`
**Classe:** `InsurancePolicy` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `company_id` | UUID | NOT NULL, INDEX |
| `policy_number` | String(100) | NOT NULL, INDEX |
| `insurer_name` | String(255) | NOT NULL |
| `insurer_cnpj` | String(18) | — |
| `broker_name` | String(255) | — |
| `broker_contact` | String(255) | — |
| `coverage_start` | Date | NOT NULL, INDEX |
| `coverage_end` | Date | NOT NULL, INDEX |
| `total_coverage_amount` | Numeric(18, 2) | NOT NULL |
...
### `model_evaluations`
**Classe:** `ModelEvaluation` | **Herda:** `Base`
...
### `risk_entries`
**Classe:** `RiskEntry` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `company_id` | UUID | NOT NULL, INDEX |
| `risk_id` | String(50) | NOT NULL, INDEX |
| `category` | String(50) | NOT NULL, INDEX |
| `title` | String(500) | NOT NULL |
| `description` | Text | — |
| `likelihood` | String(20) | NOT NULL |
| `impact` | String(20) | NOT NULL |
| `inherent_risk_score` | Integer | — |
| `residual_risk_score` | Integer | — |
| `risk_owner` | String(255) | — |
| `risk_owner_id` | UUID | INDEX |
| `mitigation_plan` | Text | — |
| `mitigation_status` | String(50) | — |
| `controls_linked` | UUID | default=list |
| `review_date` | Date | — |
| `last_reviewed_at` | DateTime | — |
| `status` | String(20) | NOT NULL, INDEX, default="identified" |
| `created_at` | DateTime | INDEX, default=func.now(, server_default |
| `updated_at` | DateTime | default=func.now(, server_default |

### `risk_treatments`
**Classe:** `RiskTreatment` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `risk_id` | UUID | NOT NULL, INDEX |
| `treatment_type` | String(20) | NOT NULL, INDEX |
| `description` | Text | — |
...
### `sod_conflicts`
**Classe:** `SoDConflict` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `company_id` | UUID | NOT NULL, INDEX |
| `role_a_id` | UUID | NOT NULL, INDEX |
| `role_b_id` | UUID | NOT NULL, INDEX |
| `conflict_type` | String(50) | NOT NULL, INDEX |
| `description` | Text | — |
| `risk_level` | String(20) | NOT NULL, default="medium" |
...
### `sod_roles`
**Classe:** `SoDRole` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `company_id` | UUID | NOT NULL, INDEX |
| `role_code` | String(50) | NOT NULL, INDEX |
| `role_name` | String(255) | NOT NULL |
| `department` | String(255) | — |
| `permissions` | String | default=list |
| `is_critical` | Boolean | default=False |
| `created_at` | DateTime | INDEX, default=func.now(, server_default |

### `sod_violations`
**Classe:** `SoDViolation` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | UUID | PK, default=uuid.uuid4 |
| `conflict_id` | UUID | NOT NULL, INDEX |
| `user_id` | UUID | NOT NULL, INDEX |
| `user_name` | String(255) | NOT NULL |
| `detected_at` | DateTime | NOT NULL, INDEX, default=func.now(, server_default |
| `resolved` | Boolean | default=False |
| `resolution_notes` | Text | — |
| `resolved_at` | DateTime | — |

### `sox_controls`
**Classe:** `SOXControl` | **Herda:** `Base`
...
### `pipeline_templates`
**Classe:** `PipelineTemplate` | **Herda:** `Base`
...
### `execution_plans`
**Classe:** `ExecutionPlan` | **Herda:** `Base`
...
### `business_rules`
**Classe:** `BusinessRule` | **Herda:** `Base`
...
### `escalation_logs`
**Classe:** `EscalationLog` | **Herda:** `Base`
...
### `escalation_rules`
**Classe:** `EscalationRule` | **Herda:** `Base`
...
**Classe:** `PolicyEvaluationLog` | **Herda:** `Base`
...
### `rate_limit_counters`
**Classe:** `RateLimitCounter` | **Herda:** `Base`
...
### `rate_limit_rules`
**Classe:** `RateLimitRule` | **Herda:** `Base`
...
**Arquivo:** `lia-agent-system/libs/models/lia_models/recruiter_decision_feedback.py`

### `recruiter_decision_feedback`
**Classe:** `RecruiterDecisionFeedback` | **Herda:** `Base`
...
| `candidate_id` | String(255) | NOT NULL, INDEX |
| `lia_score` | Float | — |
| `decision` | Enum(RecruiterDecision) | NOT NULL |
| `decision_at` | DateTime | NOT NULL, default=datetime.utcnow |
| `created_at` | DateTime | NOT NULL, default=datetime.utcnow |
| `decision_by` | String(255) | NOT NULL, default=datetime.utcnow |
...
**Classe:** `PersonalizationSettings` | **Herda:** `Base`
...
**Classe:** `ProfileCalculationLog` | **Herda:** `Base`
...
**Classe:** `RecruiterFieldPreference` | **Herda:** `Base`
...
### `recruiter_profiles`
**Classe:** `RecruiterProfile` | **Herda:** `Base`
...
**Classe:** `RecruitmentCampaign` | **Herda:** `Base`
...
**Classe:** `RecruitmentEmailTemplate` | **Herda:** `Base`
...
**Classe:** `RecruitmentAutomation` | **Herda:** `Base`
...
### `recruitment_slas`
**Classe:** `RecruitmentSLA` | **Herda:** `Base`
...
**Classe:** `RecruitmentTemplate` | **Herda:** `Base`
...
### `sla_violations`
**Classe:** `SLAViolation` | **Herda:** `Base`
...
### `ats_stage_mappings`
**Classe:** `ATSStageMapping` | **Herda:** `Base`
...
**Classe:** `CandidateStageHistory` | **Herda:** `Base`
...
### `recruitment_stages`
**Classe:** `RecruitmentStage` | **Herda:** `Base`
...
**Classe:** `RecruitmentSubStatus` | **Herda:** `Base`
...
### `screening_questions`
**Classe:** `ScreeningQuestion` | **Herda:** `Base`
...
**Classe:** `CompanyRetentionPolicy` | **Herda:** `Base`
...
### `routing_feedback`
**Classe:** `RoutingFeedback` | **Herda:** `Base`
...
### `job_requirements`
**Classe:** `JobRequirement` | **Herda:** `Base`
...
### `rubric_evaluations`
**Classe:** `RubricEvaluation` | **Herda:** `Base`
...
**Classe:** `ClientHealthMetrics` | **Herda:** `Base`
...
### `client_saas_metrics`
**Classe:** `ClientSaasMetrics` | **Herda:** `Base`
...
**Classe:** `ClientUsageMetrics` | **Herda:** `Base`
...
### `payment_history`
**Classe:** `PaymentHistory` | **Herda:** `Base`
...
### `screening_tasks`
**Classe:** `ScreeningTask` | **Herda:** `Base`
...
**Classe:** `CompanyScreeningQuestion` | **Herda:** `Base`
...
**Classe:** `ScreeningQuestionSet` | **Herda:** `Base`
...
### `search_feedbacks`
**Classe:** `SearchFeedback` | **Herda:** `Base`
...
### `interview_reminders`
**Classe:** `InterviewReminder` | **Herda:** `Base`
...
### `reschedule_history`
**Classe:** `RescheduleHistory` | **Herda:** `Base`
...
**Classe:** `SelfSchedulingLink` | **Herda:** `Base`
...
**Classe:** `SharedSearchAccess` | **Herda:** `Base`
...
**Classe:** `SharedSearchFeedback` | **Herda:** `Base`
...
### `shared_searches`
**Classe:** `SharedSearch` | **Herda:** `Base`
...
**Classe:** `BehavioralCompetencyCatalog` | **Herda:** `Base`
...
**Classe:** `CompanySkillsCatalog` | **Herda:** `Base`
...
**Classe:** `SkillSuggestionPattern` | **Herda:** `Base`
...
**Classe:** `SkillUsageAnalytics` | **Herda:** `Base`
...
**Classe:** `SourcingAgentSignal` | **Herda:** `Base`
...
### `sourcing_agents`
**Classe:** `SourcingAgent` | **Herda:** `Base`
...
**Classe:** `TalentPoolCandidate` | **Herda:** `Base`
...
### `task_templates`
**Classe:** `TaskTemplate` | **Herda:** `Base`
...
## task_record
**Arquivo:** `lia-agent-system/libs/models/lia_models/task_record.py`

### `dead_letter_queue`
**Classe:** `DeadLetterRecord` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | String | PK, default=lambda: str(uuid.uuid4( |
| `original_task_id` | String(255) | NOT NULL, INDEX |
| `domain_id` | String(100) | NOT NULL |
| `action_id` | String(100) | NOT NULL |
| `params` | JSON | default=dict |
| `error` | Text | NOT NULL |
| `retry_count` | Integer | default=0 |
| `original_created_at` | DateTime | — |
| `moved_at` | DateTime | default=datetime.utcnow |
| `resolved` | Boolean | default=False |
| `resolved_at` | DateTime | — |
| `tenant_id` | String(255) | — |
| `metadata_` | JSON | default=dict |

### `task_records`
**Classe:** `TaskRecord` | **Herda:** `Base`

| Campo | Tipo | Restrições |
|-------|------|------------|
| `id` | String | PK, default=lambda: str(uuid.uuid4( |
| `domain_id` | String(100) | NOT NULL, INDEX |
| `action_id` | String(100) | NOT NULL, INDEX |
| `params` | JSON | default=dict |
| `priority` | Integer | default=1 |
| `state` | String(20) | NOT NULL, INDEX, default="queued" |
| `result` | JSON | — |
| `error` | Text | — |
| `retry_count` | Integer | default=0 |
| `max_retries` | Integer | default=2 |
| `user_id` | String(255) | default="" |
...
### `task_schedules`
**Classe:** `TaskSchedule` | **Herda:** `Base`
...
| `priority` | Integer | default=1 |
| `tenant_id` | String(255) | — |
| `user_id` | String(255) | default="system" |
| `is_active` | Boolean | INDEX, default=True |
| `last_run_at` | DateTime | — |
| `next_run_at` | DateTime | INDEX |
| `run_count` | Integer | default=0 |
...
**Classe:** `TeamsActionAuditLog` | **Herda:** `Base`
...
### `teams_conversations`
**Classe:** `TeamsConversation` | **Herda:** `Base`
...
### `teams_messages`
**Classe:** `TeamsMessage` | **Herda:** `Base`
...
### `teams_notifications`
**Classe:** `TeamsNotification` | **Herda:** `Base`
...
| `created_at` | DateTime | default=datetime.utcnow |
| `updated_at` | DateTime | default=datetime.utcnow |
| `notification_type` | String(100) | NOT NULL |
| `status` | String(50) | default="pending" |
...
### `client_test_configs`
**Classe:** `ClientTestConfig` | **Herda:** `Base`
...
### `technical_tests`
**Classe:** `TechnicalTest` | **Herda:** `Base`
...
### `tenant_llm_configs`
**Classe:** `TenantLLMConfig` | **Herda:** `Base`
...
### `triagem_messages`
**Classe:** `TriagemMessage` | **Herda:** `Base`
...
### `triagem_sessions`
**Classe:** `TriagemSession` | **Herda:** `Base`
...
**Classe:** `TrustCenterResource` | **Herda:** `Base`
...
**Classe:** `TrustCenterSettings` | **Herda:** `Base`
...
**Classe:** `Subprocessor` | **Herda:** `Base`
...
**Classe:** `TrustCenterUpdate` | **Herda:** `Base`
...
**Classe:** `UserAgentPreference` | **Herda:** `Base`
...
**Classe:** `VoiceScreeningAnalysis` | **Herda:** `Base`
...
**Classe:** `VoiceScreeningCall` | **Herda:** `Base`
...
**Classe:** `WebhookDeliveryLog` | **Herda:** `Base`
...
**Classe:** `WebhookRegistration` | **Herda:** `Base`
...
**Classe:** `WhatsAppConversation` | **Herda:** `Base`
...
### `whatsapp_messages`
**Classe:** `WhatsAppMessage` | **Herda:** `Base`
...
### `planned_headcounts`
**Classe:** `PlannedHeadcount` | **Herda:** `Base`
...
### `workforce_entries`
**Classe:** `WorkforceEntry` | **Herda:** `Base`
...
**Classe:** `AgentWorkingMemory` | **Herda:** `Base`
